...
<cfsavecontent variable="callBackCode"><cfif (dsr eq 1)><cfoutput>try { callBack_DynamicCodeTracker(); } catch (e) { };</cfoutput></cfif></cfsavecontent>
<cftry>
	<cfif (out eq 1)>
		<cfif (Len(sig) gt 0)>
