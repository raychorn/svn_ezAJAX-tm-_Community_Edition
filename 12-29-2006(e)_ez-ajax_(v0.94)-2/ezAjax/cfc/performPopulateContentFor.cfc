<cfcomponent displayname="performPopulateContentFor" output="No" extends="userDefinedAJAXFunctions">
		...
		<cfoutput>
			<div id="div_WhatsNewContentContainer" style="margin: 5px 5px 5px 5px;">
				<table width="100%" cellpadding="-1" cellspacing="-1">
					<tr>
						<td>
							<span class="normalBigPrompt" style="color: blue; margin-bottom: 15px;">What's New ?</span><br><br>
		...
		<cfsavecontent variable="_html">
			<cfoutput>
				<cfif (pageMax gt 1)>
					...
					<span class="titlex12BoldClass">Page Index:<cfif (pageNum neq 1)>&nbsp;<a href="" onclick="#ajaxFuncName#(#t#); return false;">&lt;&lt;</a></cfif>
					<cfloop index="i" from="1" to="#pageMax#">
						...
						<cfif (pageNum neq i)><a href="" onclick="#ajaxFuncName#(#t#); return false;"></cfif>
						<cfif (pageNum eq i)>&lt;<u></cfif>#i#<cfif (pageNum eq i)></u>&gt;</cfif>
						<cfif (pageNum neq i)></a></cfif>
					</cfloop>
					<cfif (pageNum neq pageMax)>&nbsp;<a href="" onclick="#ajaxFuncName#(#(pageNum + 1)#); return false;">&gt;&gt;</a></cfif>
					&nbsp;<a href="" onclick="#ajaxFuncName#(0); return false;">All</a>
					</span>
				</cfif>
			</cfoutput>
		</cfsavecontent>
				...
				<div id="div_Web20API1ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(1, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
				...
				<div id="div_Web20API2ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(2, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
				...
				<div id="div_Web20API3ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(3, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
				...
				<div id="div_Web20API4ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(4, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
				...
				<div id="div_Web20API5ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(5, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
				...
				<div id="div_Web20API6ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(6, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
	...
	&nbsp;&nbsp;}<br>
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(7, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
	...
	============================================================<br>
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(8, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
	...
	&nbsp;&nbsp;}<br>
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(9, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
				...
				<div id="div_Web20API10ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						...
						<cfif (bool_usePageIndex)>
							<tr>
								<td align="right">
									#pageIndexFor(10, const_numberPages_Web20API, ajaxFuncName)#
								</td>
							</tr>
						</cfif>
					</table>
			...
			<cfoutput>
				<div id="div_#cName#1ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						<tr>
							<td>
								<p align="justify" class="normalx12StatusBoldClass">Make your AJAX download your JavaScript files along with your content...<br><br>
								<span class="normalSiteContentTextClass">That's right.  The JavaScript for each individual AJAX Server Command can be made to load dynamically along with the content for each Server Command.</span>
								</p>
							</td>
						</tr>
						<cfif (bool_usePageIndex)>
				...
				switch (_id) {
					...
					default:
						...
						try {
							...
							arN = ArrayLen(ar);
							if (arN eq 2) {
								_data = Evaluate('content_#ar[1]#(ar[2])');
							}
						} catch (Any e) { };
					break;
				}
