...
//		var _sSrc = 'getLocation.cfm?hash=' + windowlocator.getHash();
//		_html += "<iframe " + _sSrc + "width=\"" + this.width + "\" height=\"" + this.height + "\" name=\"" + this.ajaxID + "_ajaxnav\" id=\"" + this.ajaxID + "_ajaxnav\" frameBorder=\"1\" frameSpacing=\"0\" marginWidth=\"0\" marginHeight=\"0\" scrolling=\"Auto\"></iframe>";
		_html += '</td>';
		_html += '</tr>';
		_html += '</table>';
