...
<cfif 0>
		...
		//					handleOnClickSsmItemsByName(const_whatsNew_menu_symbol);
							whatsNewText();
						}
					} else {
						ezAlertError('Error - qData1 has an invalid value.');
