...
//	Request.importModules = 'ezThoughtBubbleObj,ezGUIActsObj,ezTables,ezFishEyeMenuObj'; // This can be a comma-delimited list of JavaScript Modules that are loaded in the order specified during the index.cfm processing cycle.  Core Modules are always loaded.
	Request.importModules = 'ezThoughtBubbleObj,ezGUIActsObj,ezTables'; // This can be a comma-delimited list of JavaScript Modules that are loaded in the order specified during the index.cfm processing cycle.  Core Modules are always loaded.
...
<cfsavecontent variable="htmlHeader">
	<cfoutput>
		...
		<script language="JavaScript1.2" type="text/javascript">
			...
			var const_Features_menu_symbol = "Features";
			var const_Installation_menu_symbol = "Installation";
			var const_RuntimeLicenses_menu_symbol = "Runtime Licenses";
			var const_Downloads_menu_symbol = "Downloads";
			var const_DocsAndGuides_menu_symbol = "Docs and Guides";
			...
			var const_SampleWeb20API_menu_symbol = "Web 2.0 API";
		</script>
		<cfif 0>
			...
			<script type="text/javascript" language="JavaScript1.2" src="/app/js/resources/stmenu.js"></script>
		</cfif>
	</cfoutput>
</cfsavecontent>
