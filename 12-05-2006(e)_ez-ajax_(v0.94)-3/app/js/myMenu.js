...
stm_aix("p1i0","p0i0",[0,"What\'s New","","",-1,-1,0,"javascript:handleOnClickSsmItems(1);whatsNewText();","_self","","","060508icon1.gif","060508icon1.gif",25,20,0,"","",0,0,0,0,1,"#FFFFF7",1,"#E5EAEF",0,"","",3,3,0,0,"#FFFFF7"],126,0);
stm_aix("p1i1","p1i0",[0,"Product Info","","",-1,-1,0,"javascript:handleOnClickSsmItems(2);whatsIsText();"],126,0);
stm_aix("p1i2","p1i0",[0,"Installation","","",-1,-1,0,"javascript:handleOnClickSsmItems(4);installationText();"],126,0);
stm_ep();
stm_aix("p0i2","p0i1",[0," Samples","","",-1,-1,0,"javascript:handleOnClickSsmItems(8);sampleAppsText();"],75,80);
...
stm_ep();
stm_aix("p0i3","p0i1",[0,"  Features","","",-1,-1,0,"javascript:handleOnClickSsmItems(3);featuresText();"],75,80);
stm_aix("p0i4","p0i1",[0,"  Downloads"],75,80);
stm_bpx("p3","p2",[]);
stm_aix("p3i0","p1i0",[0,"Docs & Guides","","",-1,-1,0,"javascript:handleOnClickSsmItems(7);downloadsDocsText();","_self","","","060508icon4.gif","060508icon4.gif"],126,0);
stm_aix("p3i1","p3i0",[0,"  Downloads","","",-1,-1,0,"javascript:handleOnClickSsmItems(6);downloadsText();"],126,0);
stm_ep();
stm_aix("p0i5","p0i1",[0,"Runtime\r\nLicenses","","",-1,-1,0,"javascript:handleOnClickSsmItems(5);runtimeLicensesText();"],0,80);
stm_aix("p0i6","p0i1",[0,"Support"],75,80);
stm_bpx("p4","p2",[]);
stm_aix("p4i0","p1i0",[0,"Support Forum","","",-1,-1,0,"javascript:handleOnClickSsmItems(9);supportForumText();","_self","","","060508icon5.gif","060508icon5.gif"],126,0);
stm_aix("p4i1","p4i0",[0,"Contact Us","","",-1,-1,0,"javascript:handleOnClickSsmItems(10);contactUsText();"],126,0);
stm_ep();
stm_em();
