...
<cfscript>
	Request.importModules = 'ezThoughtBubbleObj,ezGUIActsObj'; // This can be a comma-delimited list of JavaScript Modules that are loaded in the order specified during the index.cfm processing cycle.  Core Modules are always loaded.
