				...
				<table width="100%" cellpadding="-1" cellspacing="-1">
					<tr>
						<td>
							...
							<span class="normalPrompt"><b>ezAJAX has an expanded <a href="" onclick="try { downloadsDocsText(); } catch(e) { ezAlertError(ezErrorExplainer(e)); }; return false;">Programmer's Guide with a Tutorial Primer</a> that explains how to use ezAJAX after it has been installed.</b></span>
						</td>
					</tr>
					<tr>
						<td>
