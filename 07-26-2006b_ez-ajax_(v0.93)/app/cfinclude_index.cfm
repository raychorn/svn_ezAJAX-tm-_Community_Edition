...
//	ezAlert('qObj = [' + qObj + ']');
		...
		function getEzAJAXProductContent() {
			...
			oTabSystem1 = TabsObj.get$(30, 0, 600, 200);

			var iTab1 = oTabSystem1.addTab('What\'s New !');
			iContent = oTabSystem1.addContentForTab(iTab1, populateSiteContent(107.1, true));

			var iTab2 = oTabSystem1.addTab('What is ezAJAX' + js_trademarkSymbol);
			iContent = oTabSystem1.addContentForTab(iTab2, populateSiteContent(101.1, true));

			var iTab3 = oTabSystem1.addTab('How to Install ezAJAX' + js_trademarkSymbol);
			iContent = oTabSystem1.addContentForTab(iTab3, populateSiteContent(101.3, true));

			var iTab4 = oTabSystem1.addTab('Features List');
			iContent = oTabSystem1.addContentForTab(iTab4, populateSiteContent(105.1, true));

			var iTab5 = oTabSystem1.addTab('Manage/Upgrade Runtime Licenses');
			iContent = oTabSystem1.addContentForTab(iTab5, populateSiteContent(106.1, true));

			var iTab6 = oTabSystem1.addTab('Contact Us');
			iContent = oTabSystem1.addContentForTab(iTab6, populateSiteContent(101.2, true));

			oTabSystem1.combineTabs(iTab2, iTab3, iTab4);
