...
ezTabsObj = function(id, top, left, width, height){
	this.id = id;
...
ezTabsObj.get$ = function(top, left, width, height) {
	var instance = ezTabsObj.$[ezTabsObj.$.length];
	if (instance == null) {
		instance = ezTabsObj.$[ezTabsObj.$.length] = new ezTabsObj(ezTabsObj.$.length, top, left, width, height);
	}
	return instance;
};
...
ezTabsObj.prototype = {
	...
	destructor : function() {
		...
		return (this.id = ezTabsObj.$[this.id] = this.oTabSystem = this.oTabSystemTabs = this.oTabSystemContents = this.tabsCollection = this.contentsCollection = null);
	}
};
