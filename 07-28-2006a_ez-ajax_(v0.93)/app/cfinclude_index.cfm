...
This product currently supports Windows 2003, Windows 2000 or Windows XP.  Contact our Support Department (<a id="anchor_displayContactUs_#_uuid1023#" name="anchor_displayContactUs_#_uuid1023#" href="" onclick="displayContactUsContentIn(this.id, 'div_contactSupportContent_#_uuid1023#', 'performContactUsAction', '#Request.supportEmailAddress#'); return false;">#Request.supportEmailAddress#</a>) if you wish to install this product using a different OS than the ones we currently support.  If there is enough interest we may support other OS's than those currently supported.
			...
			<tr>
				<td>
		<p id="p_installationProcessStepDesc" align="justify" class="normalDetailedContentTextClass" style="overflow: auto; max-height: 275px; height: 275px;">
		</p>
				</td>
			</tr>
		</table>
...
<cfsavecontent variable="content_101_2"> <!--- 101.2 --->
	<cfoutput>
		...
		<td align="left" valign="top" style="border-top: thin solid Blue;">
		<span class="titlex14BoldClass">Affiliates, Contact Us. (10%-60% Commissions Paid)</span>
		<br>
...
<cfsavecontent variable="bubbleHTML">
	<cfoutput>
...
<cfsavecontent variable="content_107_1"> <!--- 107.1 --->
	<cfoutput>
		<table width="100%" cellpadding="-1" cellspacing="-1">
			...
			<tr>
				<td>
					<BIG><b>ezAJAX#cf_trademarkSymbol# Version 0.93 will include GUI Support for Tabbed Interfaces like the one you are interacting with now.</b></BIG>
					<br><br>
				</td>
			</tr>
			<tr>
					...
					<table width="100%" cellpadding="-1" cellspacing="-1">
						<tr>
							...
							<td width="*" valign="middle">
								<BIG>ezAJAX#cf_trademarkSymbol# is currently being featured at <a href="http://www.tucows.com/preview/504416" target="_blank">TuCows</a>.</BIG>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td>
					<br>
					<BIG><b>ezAJAX#cf_trademarkSymbol# Version 0.92 is now compatible with Dojo 0.3.1</b></BIG><br>
					You can <a href="" onclick="#cf_urlDojoMailSample#; return false;">view our Dojo Sample - the Mail Sample Application</a> as taken from the Dojo 0.3.1 distribution.<br>
						...
						<tr>
							<td width="50%" valign="top">
								<table width="100%" cellpadding="-1" cellspacing="-1">
									...
									<tr>
										<td align="left">
											&nbsp;<b>Email Address:</b>&nbsp;<input type="text" id="manageLicenses_emailAddress" class="textClass" tabindex="1" size="30" maxlength="255" value="" onkeyup="if (!!validateManageLicensesUserEmailAddrs()) { validateManageLicensesUserEmailAddrs() }; simulateEnterKeyForManageLicensesActions(event);"><br>
											&nbsp;<b>Server Name:</b>&nbsp;<input type="text" id="manageLicenses_serverName"  class="textClass" tabindex="2" size="50" maxlength="255" value="" onkeyup="simulateEnterKeyForManageLicensesActions(event);"><br>
...
<cfif 0>
	...
	//	ezAlert('ezObjectExplainer(window.location) = [' + ezObjectExplainer(window.location) + ']');
		...
		function simulateEnterKeyForManageLicensesActions(evt) {
			...
			if (!!oBtn) { 
				try {
					window.status = '(evt != null) = [' + (evt != null) + ']' + ', (typeof evt) = [' + (typeof evt) + ']' + ', evt.keyCode = [' + evt.keyCode + ']';
					if ( (evt != null) && ((typeof evt) == const_object_symbol) && (evt.keyCode == 13) ) { 
						if (typeof oBtn.onclick == const_function_symbol) oBtn.onclick(); 
					} 
				} catch(e) {
	//				if (typeof oBtn.onclick == const_function_symbol) oBtn.onclick(); 
					ezAlertError(ezErrorExplainer(e, 'simulateEnterKeyForManageLicensesActions()' + '\n' + ezObjectExplainer(evt), false));
				} finally {
				}
			} else { 
		...
		function sampleAJAXAppsPod() {
			var _html = '';
			_html += '<a href="" onclick="' + jsCodeDemoWaferAnalysis + '; return false;">Semiconductor Wafer Analysis' + ((!browser_is_ie) ? ' (Works best with IE 6.x)' : '') + '</a>';
				...
				if ( (!!_NAME) && (!!_DIRECTORY) && (!!_TYPE) ) {
					...
					if (!jsBool_isCurrentBlogDefault) {
						...
						if (_hRef.toUpperCase().indexOf('.EXE') > -1) {
							...
							html += '<a href="" onclick="' + jsCode + '">' + ((isTypeDir) ? '&nbsp;<img id="img_downloadsButton_' + _indentLevel + '_' + _NAME + '" src="' + _fqServerName + '/app/images/FolderClosed.gif" width="16" height="16" border="0">&nbsp;' : '&nbsp;<img src="' + _fqServerName + '/app/images/Link.gif" width="18" height="18" border="0">&nbsp;') + _NAME + '</a>';
						} else {
							html += '<a href="' + _hRef + '" target="_blank">' + ((isTypeDir) ? '&nbsp;<img id="img_downloadsButton_' + _indentLevel + '_' + _NAME + '" src="' + _fqServerName + '/app/images/FolderClosed.gif" width="16" height="16" border="0">&nbsp;' : '&nbsp;<img src="' + _fqServerName + '/app/images/Link.gif" width="18" height="18" border="0">&nbsp;') + _NAME + '</a>';
						}
					} else {
...
//	ezAlert('qObj = [' + qObj + ']');
		...
		function popUpWindowForURL(aURL, winName, xMax, yMax) {
			xMax = ((xMax != null) ? xMax : (ezClientWidth() - 450));
			yMax = ((yMax != null) ? yMax : (ezClientHeight() - 100));
			window.open(aURL,winName,'width=' + xMax + ',height=' + yMax + ',resizeable=yes,scrollbars=1');
		}
		...
		function getEzAJAXProductContent() {
			...
			oTabSystem1 = ezTabsObj.get$(0, 0, 600, 200);
		...
		<tr>
			...
			<td width="*">
				<table id="table_outerContentWrapper" width="100%" cellpadding="-1" cellspacing="-1">
					<tr>
						<td background="#Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/app/images/DiagramBuilder/new/h_blueTop.gif')#">&nbsp;</td>
					</tr>
					<tr>
									...
									<td width="100%" align="left" valign="top">
										...
										<cfelse>
											<table width="100%" border="0" cellpadding="-1" cellspacing="-1">
												<tr>
													<td width="700">
														<a href="http://www.ez-ajax.com"><img src="#Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/app/images/ezAJAX-banner_800x90.jpg')#" width="800" border="0"></a>
													</td>
													<td width="*">
					...
					<tr>
						<td valign="top">
							...
							<cfif 0>
								<tr>
									<td background="#Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/app/images/DiagramBuilder/h_blue.gif')#">&nbsp;</td>
									<td colspan="2" align="left" <cfif (cf_currentBlogName IS 'default') AND 0>bgcolor="#cf_blogBgColor#"<cfelse>background="#Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/app/images/DiagramBuilder/h_blue.gif')#"</cfif>>
					...
					<tr>
						<td valign="top" align="left">
							<br>
							<cfset newsletter_url = Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/app/NewsLetters/July2006/index.html')>
							<a href="" target="_blank" onclick="popUpWindowForURL('#newsletter_url#', 'Newsletter', 800, 600); return false;">July 2006 Newsletter</a>
							<br>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td background="#Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/app/images/DiagramBuilder/new/h_blueBottom.gif')#">&nbsp;</td>
					</tr>
				</table>
			</td>
			<td width="10" background="#Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/app/images/DiagramBuilder/new/v_blueNarrow.gif')#">
				&nbsp;
			</td>
		</tr>
	</table>
