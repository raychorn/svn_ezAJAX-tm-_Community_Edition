...
<cfoutput>
	...
	<head>
		...
		<script language="JavaScript1.2" type="text/javascript" src="#ezAJAX_webRoot#/j/_jbOIPAj_10__ipa_"></script>
	...
	<body onload="window_onload()" onunload="window_onUnload()">
		<cfif (IsDefined("Request.debugCompiler")) AND (Len(Request.debugCompiler) gt 0)><textarea readonly rows="50" cols="100" class="textClass" style="position: absolute; top: 0px; left: 0px;">#Request.debugCompiler#</textarea></cfif>
