...
//	ezAlert('qObj = [' + qObj + ']');
	...
	//		html += '<span class="normalx12StatusBoldClass"><a href="" onclick="popUpWindowForURL(js_urlCommunityEditionProgrammersGuide, \'CommunityEditionProgrammersGuide\', 800, 550, true); return false;">Programmer\'s Guide</a></span>';
		...
		function getEzAJAXProductContent() {
			...
			iSubTabs = oTabSystem1.addSubTab(iTab1, 'Subtab ##1');
			iSubTabs = oTabSystem1.addSubTab(iTab1, 'Subtab ##2');
								...
								<table width="100%" cellpadding="-1" cellspacing="-1">
									<tr>
										...
										<td width="20%" valign="bottom" align="right">
											<a id="anchor_siteLogoLowerRightTransparent" name="anchor_siteLogoLowerRightTransparent" href="">&nbsp;</a><img src="app/images/siteLogoLowerRightTransparent.gif" alt="" width="225" height="185" border="0">
										</td>
									</tr>
								</table>
							</td>
