...
ezAJAXEngine.prototype = {
	...
	html : function() {  
		...
		_html += "</form>";
		_html += '<iframe id="iframe_showAJAXBegins_' + this.ajaxID + '" src="' + this._url + 'ezAjax/blank.html' + '" frameborder="0" marginwidth="0" marginheight="0" scrolling="No" style="display: none; z-index: 1; background-color: silver;"></iframe>';
