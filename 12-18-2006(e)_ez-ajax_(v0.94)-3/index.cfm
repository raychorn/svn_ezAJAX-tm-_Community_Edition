...
<cfoutput>
	...
	<head>
		...
		<script language="JavaScript1.2" type="text/javascript">
			var _javaScriptLoaderParms = '?out=0&modules=#URLEncodedFormat(Request.importModules)#';
		</script>
		...
		<cfelseif 1> <!--- +++ --->
			<script language="JavaScript1.2" type="text/javascript" src="#ezAJAX_webRoot#/ezAjax/loader.cfm?out=0&modules=#URLEncodedFormat(Request.importModules)#&sig=#URLEncodedFormat(Trim(_asBlowfishEncryptedHex(DateFormat(Now(), "mm/dd/yyyy") & "_" & TimeFormat(Now(), "hh:mm:ss tt"))))#"></script>
		<cfelseif 0>
