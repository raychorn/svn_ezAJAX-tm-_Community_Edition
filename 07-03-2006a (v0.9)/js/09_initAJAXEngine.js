function initAJAXEngine(_oAJAXEngine) {
	...
	try {
		...
		_oAJAXEngine.onReceive = function (){
			...
			if (this.bool_echoReceivedBytesToWindowStatus) window.status = byteCount + ' bytes rcvd from ezAJAX(tm)' + ', mode is ' + _oAJAXEngine.mode + ', method is ' + _oAJAXEngine.method + ', isXmlHttpPreferred is ' + _oAJAXEngine.isXmlHttpPreferred;
