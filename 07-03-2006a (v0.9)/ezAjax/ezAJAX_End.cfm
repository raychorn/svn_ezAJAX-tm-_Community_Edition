...
<cfif (IsDefined("Request.commonCode.aRuntimeLicenseStruct.ISCOMMUNITYEDITION")) AND (Request.commonCode.aRuntimeLicenseStruct.ISCOMMUNITYEDITION)>
	<cfscript>
...
<cfscript>
	...
	if (NOT IsDefined("Request.qryStruct.ezCallBack")) {
		Request.qryStruct.ezCallBack = '_alert("No callback was specified...")';
	}
	if (UCASE(Request.qryStruct.ezCallBack) neq 'UNDEFINED') {
		_jsFinaleCode = Request.qryStruct.ezCallBack;
