...
<cfscript>
	_aRuntimeLicenseStruct = Request.commonCode._aRuntimeLicenseStruct(CreateUUID());
//	if ( (IsDefined("_aRuntimeLicenseStruct.ISCOMMUNITYEDITION")) AND (_aRuntimeLicenseStruct.ISCOMMUNITYEDITION) ) {
//		_aRuntimeLicenseStruct.ISCOMMUNITYEDITION = false;
//	}
</cfscript>
<cfif (IsDefined("_aRuntimeLicenseStruct.ISCOMMUNITYEDITION")) AND (_aRuntimeLicenseStruct.ISCOMMUNITYEDITION)>
	<cfscript>
