...
<cfscript>
	...
	QuerySetCell(qFeatures, 'sFeature', "<b>10,000 Lines of Robust Reusable Code.</b>", qFeatures.recordCount);
...
<cfsavecontent variable="content_102_1"> <!--- 102.1 --->
	<cfoutput>
		<p class="normalSiteContentTextClass">More than 8000 lines of JavaScript code AND more than 2000 lines of ColdFusion MX 7 code.</p>
	</cfoutput>
</cfsavecontent>
...
<cfsavecontent variable="content_104_2"> <!--- 104.02 --->
	<cfoutput>
(2). <a id="anchor_productDownload" href="" target="_blank" onclick="clickProductDownloadAnchor(); return true;">Download the ezAJAX#cf_trademarkSymbol# Installer program</a> to your web server in a folder other than the one that was created or set aside for <a href="" onclick="populateSiteContent(104.01); return false;">Step (1)</a>.  The <a id="anchor_productDownload" href="" target="_blank" onclick="clickProductDownloadAnchor(); return true;">ezAJAX#cf_trademarkSymbol# Installer program</a> <b><u>MUST</u></b> be executed using the <u>same</u> Physical Server as the one to which you are installing the ezAJAX#cf_trademarkSymbol# product.  You <b><u>cannot</u></b> do a remote installation across a network, this will not work.  Additionally, the <a id="anchor_productDownload" href="" target="_blank" onclick="clickProductDownloadAnchor(); return true;">ezAJAX#cf_trademarkSymbol# Installer program</a> works much better when it is running from a folder that has nothing it in but the <a id="anchor_productDownload" href="" target="_blank" onclick="clickProductDownloadAnchor(); return true;">ezAJAX#cf_trademarkSymbol# Installer program</a>.
	</cfoutput>
</cfsavecontent>

<cfsavecontent variable="content_104_3"> <!--- 104.03 --->
	<cfoutput>
(3). Double-Click on the ezAJAX#cf_trademarkSymbol# Installer program and click on the "I Agree" button to begin the Installation Process.
	</cfoutput>
</cfsavecontent>

<cfsavecontent variable="content_104_4"> <!--- 104.04 --->
	<cfoutput>
...
<cfsavecontent variable="content_104_5"> <!--- 104.05 --->
	<cfoutput>
...
<cfsavecontent variable="content_104_8"> <!--- 104.08 --->
	<cfoutput>
(8). If you encounter any problems during the Installation Process simply contact our Support Department (<a href="" onclick="displayContactUsContentIn('div_contactSupportContent_#_uuid8#', 'performContactUsAction', '#Request.supportEmailAddress#'); return false;">#Request.supportEmailAddress#</a>) to get the problem resolved.  Our Support Department will not be able to send you a Runtime License file but they will be able to tell you what went wrong during the Installation Process so you can resolve the problem and achieve a successful installation.
	</cfoutput>
</cfsavecontent>

<cfsavecontent variable="content_104_9"> <!--- 104.09 --->
	<cfoutput>
...
<cfsavecontent variable="content_104_10"> <!--- 104.10 --->
	<cfoutput>
(10). The ezAJAX#cf_trademarkSymbol# Community Edition supports any version of ColdFusion MX 7 using any web server supported by ColdFusion MX 7.  Be sure to let our Support Department (<a href="" onclick="displayContactUsContentIn('div_contactSupportContent_#_uuid10#', 'performContactUsAction', '#Request.supportEmailAddress#'); return false;">#Request.supportEmailAddress#</a>) know if you encounter anything that differs from this.
	</cfoutput>
</cfsavecontent>
...
This product currently supports Windows 2003, Windows 2000 or Windows XP.  Contact our Support Department (<a href="" onclick="displayContactUsContentIn('div_contactSupportContent_#_uuid1023#', 'performContactUsAction', '#Request.supportEmailAddress#'); return false;">#Request.supportEmailAddress#</a>) if you wish to install this product using a different OS than the ones we currently support.  If there is enough interest we may support other OS's than those currently supported.
					</p>
				</td>
			</tr>
			<tr>
				<td>
					<table width="100%" border="0" cellpadding="5" cellspacing="5">
						<tr>
							<td id="td_container_InstallProcess.1" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.01); return false;">
								1
							</td>
							<td id="td_container_InstallProcess.2" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.02); return false;">
								2
							</td>
							<td id="td_container_InstallProcess.3" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.03); return false;">
								3
							</td>
							<td id="td_container_InstallProcess.4" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.04); return false;">
								4
							</td>
							<td id="td_container_InstallProcess.5" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.05); return false;">
								5
							</td>
							<td id="td_container_InstallProcess.6" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.06); return false;">
								6
							</td>
							<td id="td_container_InstallProcess.7" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.07); return false;">
								7
							</td>
							<td id="td_container_InstallProcess.8" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.08); return false;">
								8
							</td>
							<td id="td_container_InstallProcess.9" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.09); return false;">
								9
							</td>
							<td id="td_container_InstallProcess.10" align="center" class="installProcessUnSelectedClass" onclick="populateSiteContent(104.10); return false;">
								10
							</td>
						</tr>
					</table>
			...
			<tr>
				<td>
		<p id="p_installationProcessStepDesc" align="justify" class="normalDetailedContentTextClass" style="overflow: auto; max-height: 75px; height: 75px;">
		</p>
				</td>
			</tr>
		</table>
		...
		<table width="100%" cellpadding="-1" cellspacing="-1">
			<tr>
				<td bgcolor="silver" align="center">
					ezAJAX#cf_trademarkSymbol# Community Edition Features
				</td>
			</tr>
			<tr>
				<td>
...
<cfsavecontent variable="content_101_2"> <!--- 101.2 --->
	<cfoutput>
		<table width="100%" cellpadding="-1" cellspacing="-1">
		<tr>
		<td align="left" valign="top" style="border-top: thin solid Blue;">
		<span class="titlex14BoldClass">Contact Us</span>
		<br>
		<span class="normalx12StatusBoldClass"><a href="" onclick="displayContactUsContentIn('div_contactUsContent', 'performContactUsAction', '#Request.salesEmailAddress#'); return false;">#Request.salesEmailAddress#</a></span>
		<div id="div_contactUsContent"></div>
		</td>
		<td align="left" valign="top" style="border-top: thin solid Blue;">
		<span class="titlex14BoldClass">Investors, Contact Us.</span>
		<br>
		<span class="normalx12StatusBoldClass"><a href="" onclick="displayContactUsContentIn('div_contactUsContent', 'performContactUsAction', '#Request.investorRelationsEmailAddress#'); return false;">#Request.investorRelationsEmailAddress#</a></span>
		</td>
		<td align="left" valign="top" style="border-top: thin solid Blue;">
		<span class="titlex14BoldClass">Affiliates, Contact Us. (10%-60% Comissions Paid)</span>
		<br>
		<span class="normalx12StatusBoldClass"><a href="" onclick="displayContactUsContentIn('div_contactUsContent', 'performContactUsAction', '#Request.affiliateRelationsEmailAddress#'); return false;">#Request.affiliateRelationsEmailAddress#</a></span>
		</td>
		</tr>
		</table>
	</cfoutput>
...
<cfsavecontent variable="content_107_1"> <!--- 107.1 --->
	<cfoutput>
		<h3 style="color: blue;">What's New ?</h3>
		<BIG><b>ezAJAX#cf_trademarkSymbol# is now compatible with Dojo 0.3.1</b></BIG><br>
		You can <a href="" onclick="#cf_urlDojoMailSample#; return false;">view our Dojo Sample - the Mail Sample Application</a> as taken from the Dojo 0.3.1 distribution.<br><br>
		It was quite easy to integrate ezAJAX#cf_trademarkSymbol# with Dojo 0.3.1 - ezAJAX#cf_trademarkSymbol# offers a superior AJAX Engine that compliments the slick GUI effects found in Dojo 0.3.1.
		<br>
		<h3 style="color: blue;">Coming Soon...</h3>
		<BIG><b>ezAJAX#cf_trademarkSymbol# will soon have an expanded Programmer's Guide complete with programming examples and a Tutorial Primer that explains how to use the ezAJAX#cf_trademarkSymbol# Framework.</b></BIG><br>
	</cfoutput>
</cfsavecontent>
								...
								<table width="100%" cellpadding="-1" cellspacing="-1">
									<tr>
										<td align="center" bgcolor="silver">
											<b>Manage my Runtime Licenses</b>
										</td>
									</tr>
									<tr>
										<td>
											<p align="justify">Enter the EMail Address and Server Name you used when you Installed your copy of ezAJAX#cf_trademarkSymbol#. <a id="anchor_productDownload" href="" target="_blank" onclick="clickProductDownloadAnchor(); return true;">Download the ezAJAX#cf_trademarkSymbol# Installer program</a> and Install ezAJAX#cf_trademarkSymbol# to get your Runtime License for your 30-day Trial and then return here to Manage your Runtime Licenses.</p>
											<p align="justify">The Runtime License Management System cannot issue Runtime Licenses but it can resend your Runtime Licenses to your EMail Address.  The Runtime License Management System also allows you to change your email address in case your email address has changed since your Runtime License was issued.</p>
										</td>
									</tr>
									<tr>
										<td align="left">
											&nbsp;<b>Email Address:</b>&nbsp;<input type="text" id="manageLicenses_emailAddress" class="textClass" size="30" maxlength="255" value="" onkeyup="if (!!validateManageLicensesUserEmailAddrs()) { validateManageLicensesUserEmailAddrs() }; simulateEnterKeyForManageLicensesActions();"><br>
											&nbsp;<b>Server Name:</b>&nbsp;<input type="text" id="manageLicenses_serverName"  class="textClass"size="50" maxlength="255" value="" onkeyup="simulateEnterKeyForManageLicensesActions();"><br>
											&nbsp;<button id="btn_manageLicenses_Submit" type="button" disabled class="#cf_buttonClass#" onclick="var oInput1 = _$('manageLicenses_emailAddress'); var oInput2 = _$('manageLicenses_serverName'); var oCancel = _$('btn_manageLicenses_Cancel'); if ( (!!oInput1) && (!!oInput2) && (!!oCancel) ) { if ( (oInput1.value.length > 0) && (oInput2.value.length > 0) ) { oGuiActions.pushButton(this.id); oGuiActions.pushButton(oCancel.id); oGuiActions.pushButton(oInput1.id); oGuiActions.pushButton(oInput2.id); /*this.disabled = true; oCancel.disabled = true; oInput1.disabled = true; oInput2.disabled = true;*/ oAJAXEngine.doAJAX('performGetRegistrationData', 'handleGetRegistrationData', 'emailAddress', oInput1.value, 'serverName', oInput2.value); } else { alert('Missing values for EMail Address and/or Server Name.'); } } else { alert('ERROR: Programming Error - Unable to fetch the value for \'emailAddress\' and/or \'serverName\'.'); } return false;">[Retrieve Runtime Licenses]</button>&nbsp;
											&nbsp;<button id="btn_manageLicenses_Cancel" type="button" class="#cf_buttonClass#" onclick="populateSiteContent(106.2); return false;">[Cancel]</button>
										</td>
									</tr>
								</table>
							</td>
...
<cfoutput>
	...
	//			dObj.innerHTML = '&nbsp;<b>Extra Menu Content</b>';
		...
		oAJAXEngine.showAJAXBeginsHrefCallback = function (hRef) { return ezURLPrefixFromHref(js_SERVER_NAME); };
...
//		ezAlert(oAJAXEngine);
	...
	<cfscript>
		...
		_urlCommunityEditionProgrammersGuide = _urlParentPrefix & "/downloads_433611211010024813/ezAJAX(tm) Community Edition Programmer's Guide.htm";
...
<cfif 0>
	...
	//	ezAlert('ezObjectExplainer(window.location) = [' + ezObjectExplainer(window.location) + ']');
		...
		function simulateEnterKeyForManageLicensesActions() {
		...
		function simulateEnterKeyForEditLicensesActions() {
		...
		function podLayoutHTML(contentHTML, title, podName, vararg_params) {
			...
			try {
				...
				_html += ((bool_doesContainerExist) ? '' : '<div id="div_podLayoutContainer_' + podName + '" style="width: 400px; overflow: auto;' + _styles + '">');
		...
		function sampleAJAXAppsPod() {
			var _html = '';
			_html += '<a href="" onclick="' + jsCodeDemoWaferAnalysis + '; return false;">Semiconductor Wafer Analysis</a>';
		...
		function sampleDojoAppsPod() {
			var _html = '';
			_html += '<a href="" onclick="' + jsCodeDemoDojoMailSample + '; return false;">Dojo Mail Sample</a><br>';
			_html += '<a href="" onclick="oAJAXEngine.doAJAX(\'performRetrieveSourceCodeFromURL\', \'handleRetrieveSourceCodeFromURL\', \'filename\', \'#_urlDojoMailSample#\'); return false;">Dojo Mail Sample (Source)</a>';
	...
	//			ezErrorExplainer(e, '111', true);
		...
		function refresh3DLogo() {
			...
			if (!!oDiv) {
				...
				oDiv.innerHTML = '<a href="http://www.ez-ajax.com"><img src="app/images/' + _src + '" width="200" border="0"></a>';
				count_refresh3DLogo++;
			}
		}
		...
		function beginUpgradeRuntimeLicense(id, sid, iTerm) {
			...
			if (!!oDiv) {
				_html += '<table width="100%" cellpadding="5" cellspacing="5">';
				...
				switch (iTerm) {
					case 12:
						...
						_html += '<img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">';
						_html += '</form>';
						_html += '<br><i>HAL Smalltalker, Inc. is responsible for processing our payments.</i>';
						
						_html += '</td>';
		
						_html += '<td width="*">';
						_html += '<b>Click this button (to the left) to upgrade your Runtime License to the Community Edition Annual License for a cost of <b>$95</b>/year/Server.  This grants you the ability to use the Community Edition for a longer period than the 30-day Trial allows and it grants you the ability to use the Community Edition for certain Commercial Purposes in accordance with the <a href="" onclick="popUpWindowForURL(js_urlCommunityEditionLicenseAgreement, \'CommunityEditionLicenseAgreement\'); return false;">License Agreement</a>.  Please allow 24-48 hours for your payment to be processed after which your updated Runtime License will be emailed to you.  It is our policy to issue an interim 90-day Runtime License upon receipt of your payment; we will issue your Annual Runtime License at the end of this interim 90-day period.</b>';
						_html += '</td>';
					...
					default:
						...
						_html += '<td width="*">';
						_html += '<b>Click this button (to the left) to upgrade your Runtime License to the Community Edition Perpetual License for a cost of <b>$495</b>/year/Server.  This grants you the ability to use the Community Edition for a longer period than the 30-day Trial allows and it grants you the ability to use the Community Edition for certain Commercial Purposes in accordance with the <a href="" onclick="popUpWindowForURL(js_urlCommunityEditionLicenseAgreement, \'CommunityEditionLicenseAgreement\'); return false;">License Agreement</a>.  Please allow 24-48 hours for your payment to be processed after which your updated Runtime License will be emailed to you.  It is our policy to issue an interim 90-day Runtime License upon receipt of your payment; we will issue your Perpetual Runtime License at the end of this interim 90-day period.</b>';
						_html += '</td>';
		...
		function handleGetRegistrationData(qObj, nRecs, qStats, argsDict, qData1) {
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						qData1[0].iterateRecObjs(searchForStatusRecs);
						qData1[0].iterateRecObjs(searchForLicenseRecs);
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						...
						qData1[0].iterateRecObjs(searchForRecentArticles);
						...
						if (!isBoolUpdate) {
							...
							if (!!dObj) {
								...
								podLayoutContainerStylesCallBack = -1;
								dObj.innerHTML += ((jsBool_isCurrentBlogDefault) ? rapContent : '') + ((jsBool_isCurrentBlogDefault) ? paypalPod() : '') + sampleAJAXAppsPod() + sampleDojoAppsPod();
		...
		function handleGetDownloadsMetaData(qObj, nRecs, qStats, argsDict, qData1) {
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						qData1[0].iterateRecObjs(searchForDirData);
		...
		function handleGetDownloadsFolder(qObj, nRecs, qStats, argsDict, qData1) {
			...
			//		var _hRef = ezFilePath2HrefUsingCommonFolder(bName, hRef, cFolder);
					...
					if (!jsBool_isCurrentBlogDefault) {
						...
						html += '<a href="' + _hRef + '" target="_blank">' + ((isTypeDir) ? '&nbsp;<img id="img_downloadsButton_' + _indentLevel + '_' + _NAME + '" src="' + _fqServerName + '/app/images/FolderClosed.gif" width="16" height="16" border="0">&nbsp;' : '&nbsp;<img src="' + _fqServerName + '/app/images/Link.gif" width="18" height="18" border="0">&nbsp;') + _NAME + '</a>';
					} else {
...
//	ezAlert('qObj = [' + qObj + ']');
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						...
						qData1[0].iterateRecObjs(searchForCalendarMetaData);
		...
		function popUpWindowForURL(aURL, winName) {
			window.open(aURL,winName,'width=' + (ezClientWidth() - 450) + ',height=' + (ezClientHeight() - 100) + ',resizeable=yes,scrollbars=1');
		}
		...
		function populateSiteContent(num) {
			var i = -1;
			var html = '';
			var delayedFunctionCall = '';
			var iDiv = ezInt(num);
			var oDiv = _$((((iDiv == 101) || (iDiv == 105) || (iDiv == 106)) ? 'div_siteContents' : ((iDiv == 102) ? 'div_linesOfCodeContent' : ((iDiv == 103) ? 'div_allTheWorkContent' : ((iDiv == 104) ? 'p_installationProcessStepDesc' : ((iDiv == 107) ? 'div_siteNewsContents' : ''))))));
			if (!!oDiv) {
				switch (num) {
					case 101.1:
					...
					case 104.03:
						html = '#JSStringFormat(content_104_3)#';
						for (i = 1; i <= 10; i++) {
							if (i > 3) {
								delayedFunctionCall += "setClassForElement('td_container_InstallProcess." + i + "', 'installProcessUnSelectedClass'); ";
							} else {
					...
					case 104.05:
						html = '#JSStringFormat(content_104_5)#';
						for (i = 1; i <= 10; i++) {
							if (i > 5) {
								delayedFunctionCall += "setClassForElement('td_container_InstallProcess." + i + "', 'installProcessUnSelectedClass'); ";
							} else {
					...
					case 104.06:
						html = '#JSStringFormat(content_104_6)#';
						for (i = 1; i <= 10; i++) {
							if (i > 6) {
								delayedFunctionCall += "setClassForElement('td_container_InstallProcess." + i + "', 'installProcessUnSelectedClass'); ";
							} else {
					...
					case 104.07:
						html = '#JSStringFormat(content_104_7)#';
						for (i = 1; i <= 10; i++) {
							if (i > 7) {
								delayedFunctionCall += "setClassForElement('td_container_InstallProcess." + i + "', 'installProcessUnSelectedClass'); ";
							} else {
					...
					case 104.08:
						html = '#JSStringFormat(content_104_8)#';
						for (i = 1; i <= 10; i++) {
							if (i > 8) {
								delayedFunctionCall += "setClassForElement('td_container_InstallProcess." + i + "', 'installProcessUnSelectedClass'); ";
							} else {
					...
					case 104.09:
						html = '#JSStringFormat(content_104_9)#';
						for (i = 1; i <= 10; i++) {
							if (i > 9) {
								delayedFunctionCall += "setClassForElement('td_container_InstallProcess." + i + "', 'installProcessUnSelectedClass'); ";
							} else {
					...
					case 104.10:
						html = '#JSStringFormat(content_104_10)#';
						for (i = 1; i <= 10; i++) {
							if (i > 10) {
								delayedFunctionCall += "setClassForElement('td_container_InstallProcess." + i + "', 'installProcessUnSelectedClass'); ";
							} else {
				...
				oDiv.innerHTML = html.ezStripCrLfs().ezTrim();
		...
		function clickProductDownloadAnchor() {
			var oAnchor = _$('anchor_productDownload');
			if (!!oAnchor) {
		...
		function getEzAJAXProductContent() {
			...
			var tabs_html = '';
			var _disp_tabNum = 1;
			var _displayableNum = 1;
			var _classTab = 'tab';
			var _classTabActive = 'tab tabActive';

			var oTabSystemContainer = _$('TabSystemContainer');
			if (!!TabSystemContainer) {
				tabs_html += '<div id="TabSystem1" class="content">';
				tabs_html += '<div id="div_TabSystem1_tabs" class="tabs">';
				tabs_html += '<div id="cell_tab1" style="display: inline;">';
				tabs_html += '<a href="##1" accesskey="' + _disp_tabNum + '" tabindex="' + _disp_tabNum + '" id="tab' + _disp_tabNum + '" title="Tab 1" class="' + _classTabActive + '">';
				tabs_html += '&nbsp;<font size="1"><small>Tab 1 Title&nbsp;(' + _disp_tabNum + '/' + _displayableNum + ')</small></font>';
				tabs_html += '</a>';
				tabs_html += '</div>';
				_disp_tabNum++;
				tabs_html += '<div id="cell_tab2" style="display: inline;">';
				tabs_html += '<a href="##2" accesskey="' + _disp_tabNum + '" tabindex="' + _disp_tabNum + '" id="tab' + _disp_tabNum + '" title="Tab 2" class="' + _classTab + '">';
				tabs_html += '&nbsp;<font size="1"><small>Tab 2 Title&nbsp;(' + _disp_tabNum + '/' + _displayableNum + ')</small></font>';
				tabs_html += '</a>';
				tabs_html += '</div>';
				tabs_html += '</div>';
				_disp_tabNum = 1;
				tabs_html += '<div id="content' + _disp_tabNum + '" class="content" style="display: inline;">';
				tabs_html += '<b>Content 1</b>';
				tabs_html += '</div>';
				_disp_tabNum++;
				tabs_html += '<div id="content' + _disp_tabNum + '" class="content" style="display: none;">';
				tabs_html += '<b>Content 2</b>';
				tabs_html += '</div>';
				tabs_html += '</div>';

				TabSystemContainer.innerHTML = tabs_html;
			}
			...
			html += '<td bgcolor="##0000ff">';
			html += '<a href="" onclick="populateSiteContent(101.1); return false;"><span class="menux11StatusBoldClass"><u>What is ezAJAX' + js_trademarkSymbol + '</u></span></a>';
			html += '</td>';

			html += '<td bgcolor="##0000ff">';
			html += '<a href="" onclick="populateSiteContent(101.3); return false;"><span class="menux11StatusBoldClass"><u>How to Install ezAJAX' + js_trademarkSymbol + '</u></span></a>';
			html += '</td>';

			html += '<td bgcolor="##0000ff">';
			html += '<a href="" onclick="populateSiteContent(105.1); return false;"><span class="menux11StatusBoldClass"><u>Features List</u></span></a>';
			html += '</td>';

			html += '<td bgcolor="##0000ff">';
			html += '<a href="" onclick="populateSiteContent(106.1); return false;"><span class="menux11StatusBoldClass"><u>Manage/Upgrade Runtime Licenses</u></span></a>';
			html += '</td>';

			html += '<td bgcolor="##0000ff">';
			html += '<a href="" onclick="populateSiteContent(101.2); return false;"><span class="menux11StatusBoldClass"><u>Contact Us</u></span></a>';
			html += '</td>';
			...
			if (0) {
				...
				html += '<tr>';
				html += '<td>';
				html += '<span class="normalx11StatusBoldClass"><p align="justify">We used the ezAJAX' + js_trademarkSymbol + ' Enterprise Edition Framework to build the <a href="" onclick="' + jsCodeDemoWaferAnalysis + '; return false;"><span class="titlex12BlackBoldClass">Semiconductor Wafer Analysis Prototype</span></a> in less than one week of development.<br><br></p></span>';
				html += '</td>';
				html += '</tr>';
	
				html += '<tr>';
				html += '<td>';
				html += '<span class="normalx11StatusBoldClass"><p align="justify"><span class="titlex12BlackBoldClass">Our Service Guarantee:</span> Download and Install the ezAJAX' + js_trademarkSymbol + ' Framework and then Buy a Perpetual Runtime License and we will work with you to ensure you have those features that are most important to you built into the Framework.  We will also fix every single bug you report to us in a timely manner.  We will continue to work to make our products the best in the industry, without exception.<br><br></p></span>';
				html += '</td>';
				html += '</tr>';
	
				html += '<tr>';
				html += '<td>';
				html += '<span class="normalx11StatusBoldClass"><p align="justify"><span class="titlex12BlackBoldClass">Under Development:</span> The ezAJAX' + js_trademarkSymbol + ' Enterprise Edition Framework will be released soon at this site.<br><br></p></span>';
				html += '</td>';
				html += '</tr>';
			}
			...
			imgName = _fqServerName + '/app/images/downloadTrialEdition.gif';
...
// +++
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						...
						html += '<table width="100%" cellpadding="-1" cellspacing="-1">';
						qData1[0].iterateRecObjs(searchForArchives);
						html += '</table>';
						
						archivesByCategoryQObj = qData1[0];
		...
		function handleAdminEditEntry(qObj, nRecs, qStats, argsDict, qData1) {
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						qData1[0].iterateRecObjs(searchForEditableArticle);
					...
					if (!!qData1) {
						...
						if ( (!!_id) && (!!_catIds) ) {
							...
							if (!!oDiv) {
								...
								stack_blogCategoryReassignmentQueries.push(qData1[0]);
								qData1[0].iterateRecObjs(searchForCategories);
								oDiv.innerHTML = html;
							}
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						...
						if (qData1.length == 2) qData1[1].iterateRecObjs(searchForBlogSettings);
						blogRecordCount = qData1[0].recordCount();
						qData1[0].iterateRecObjs(searchForBlogArticles);
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						...
						qData1[0].iterateRecObjs(searchForComments);
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						...
						qData1[0].iterateRecObjs(searchForTrackbacks);
		...
		function handleGetPodCount(qObj, nRecs, qStats, argsDict, qData1) {
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						qData1[0].iterateRecObjs(searchForPodsCount);
						
						if (podsDict != -1) {
							if (qData1.length == 2) {
								qData1[1].iterateRecObjs(searchForPodNames);
		...
		function handleGetPodByName(qObj, nRecs, qStats, argsDict, qData1) {
			...
			if (!!qStats) {
				if (!!argsDict) {
					if (!!qData1) {
						qData1[0].iterateRecObjs(searchForPodData);
	...
	<cfsavecontent variable="ezClusterLink">
		<cfoutput>
			...
			<cfelse>
				<span class="normalBoldGreenPrompt">ezCluster&##8482</span>
			</cfif>
		</cfoutput>
	</cfsavecontent>
	<cfsavecontent variable="ezAJAXLink">
		<cfoutput>
			<cfif 0>
				<a href="#ezAJAX_productLink#" target="_blank"><span class="normalBoldGreenPrompt">ezAJAX&##8482</span></a>
			<cfelse>
				<span class="normalBoldGreenPrompt">ezAJAX&##8482</span>
			</cfif>
		</cfoutput>
	</cfsavecontent>
	<cfsavecontent variable="_poweredHTML">
		<cfoutput>
			<span class="normalBluePrompt">This Site is powered by </span>#ezClusterLink#.&nbsp;
			...
			&nbsp;
			<span class="normalBluePrompt">This Site is powered by #ezAJAXLink#.  #ezAJAXLink# makes it Easy to Create and Publish your AJAX Web Apps.  Let us do all the work for you.</span>
			<br>
			The contents of this Site are protected under U.S. and International Copyright Laws. &copy 1990-#Year(Now())# Hierarchical Applications Limited, All Rights Reserved.
		</cfoutput>
	</cfsavecontent>
	
	<table width="100%" cellpadding="-1" cellspacing="-1" style="background-color: white;">
		<tr>
			<td width="10" background="#_urlParentPrefix#/app/images/DiagramBuilder/new/v_blueNarrow.gif">
				&nbsp;
			</td>
			<td width="*">
				<table id="table_outerContentWrapper" width="100%" cellpadding="-1" cellspacing="-1">
					<tr>
						<td background="#_urlParentPrefix#/app/images/DiagramBuilder/new/h_blueTop.gif">&nbsp;</td>
					</tr>
					<tr>
								...
								<tr>
									<td width="100%" align="left" valign="top">
										...
										<cfelse>
											<table width="100%" border="0" cellpadding="-1" cellspacing="-1">
												<tr>
													<td width="700">
														<a href="http://www.ez-ajax.com"><img src="app/images/ezAJAX-banner_800x90.jpg" width="700" height="90" border="0"></a>
													</td>
													<td width="*">
									...
									<cfif 0>
										<td width="*" align="left" valign="top">
											...
											<iframe id="iframe_ezAJAX_LogoPod" frameborder="0" width="200" height="70" scrolling="No" src="#logoImage#"></iframe>
										</td>
									</cfif>
					...
					<tr>
						<td valign="top">
							<table width="100%" cellpadding="-1" cellspacing="-1">
								<tr>
									<td background="#_urlParentPrefix#/app/images/DiagramBuilder/h_blue.gif">&nbsp;</td>
									<td colspan="2" align="left" <cfif (cf_currentBlogName IS 'default') AND 0>bgcolor="#cf_blogBgColor#"<cfelse>background="#_urlParentPrefix#/app/images/DiagramBuilder/h_blue.gif"</cfif>>
										<cfif (cf_currentBlogName IS 'default')>
											<button id="btn_expandBlogCols" disabled class="#cf_buttonClass#" onclick="expandBlogRightCol(this); return false;" style="display: none;">#cf_const_expandButtonFace#</button>
										</cfif>
									</td>
								</tr>
								<tr>
									<td id="td_articleContent" width="100%" valign="top" align="left" style="border-right: thin dotted Silver;">
										<table width="100%" cellpadding="-1" cellspacing="-1">
											<tr>
					...
					<tr>
						<td background="#_urlParentPrefix#/app/images/DiagramBuilder/new/h_blueBottom.gif">&nbsp;</td>
					</tr>
				</table>
			</td>
			<td width="10" background="#_urlParentPrefix#/app/images/DiagramBuilder/new/v_blueNarrow.gif">
