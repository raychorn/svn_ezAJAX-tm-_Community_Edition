<cfcomponent displayname="performPopulateContentFor" output="No" extends="userDefinedAJAXFunctions">
	...
	<cfsavecontent variable="content_Web20API">
		<cfoutput>
			<div id="div_Web20APIContentContainer" style="margin: 5px 5px 5px 5px;">
				<table width="100%">
					<tr>
						<td>
							<p align="justify" class="normalSiteContentTextClass">A.</p>
							<p align="justify" class="normalSiteContentTextClass">B.</p>
						</td>
					</tr>
				</table>
			</div>
