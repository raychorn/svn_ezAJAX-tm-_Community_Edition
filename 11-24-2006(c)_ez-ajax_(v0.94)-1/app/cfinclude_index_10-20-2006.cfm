...
//		ezAlert('bool_useAbsoluteServerBusyPositioning = [' + bool_useAbsoluteServerBusyPositioning + ']');
...
<cfif 0>
	...
	//	ezAlert('browser_is_ie = [' + browser_is_ie + ']' + ', browser_is_ff = [' + browser_is_ff + ']' + ', browser_is_ns = [' + browser_is_ns + ']' + ', browser_is_op = [' + browser_is_op + ']'); 
						...
						<tr>
							<td width="100%" valign="top">
								<table width="100%" cellpadding="-1" cellspacing="-1" class="bannerWhiteTable">
									...
									<tr>
										<td align="center">
											<b>This is the <U>MUST-HAVE</U> Web 2.0 Product of #Year(Now())# !</b>
										</td>
									</tr>
								</table>
							</td>
	...
	<script language="JavaScript1.2" type="text/javascript">
		...
		handleOnClickSsmItems(1);whatsNewText();
//		showFloatingMenu();
	</script>
