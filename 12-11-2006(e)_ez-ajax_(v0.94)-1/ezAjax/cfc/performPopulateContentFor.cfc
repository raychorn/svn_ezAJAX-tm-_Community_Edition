<cfcomponent displayname="performPopulateContentFor" output="No" extends="userDefinedAJAXFunctions">
	...
	<cfset const_numberPages_Web20API = 10>
	...
	<cfsavecontent variable="content_Web20API_5">
		<cfoutput>
	...
	<cfsavecontent variable="content_Web20API_6">
		<cfoutput>
	...
	<cfsavecontent variable="content_Web20API_7">
		<cfoutput>
...
&nbsp;&nbsp;}<br>
	...
	<cfsavecontent variable="content_Web20API_8">
		<cfoutput>
...
============================================================<br>
	...
	<cfsavecontent variable="content_Web20API_9">
		<cfoutput>
...
&nbsp;&nbsp;}<br>
	...
	<cfsavecontent variable="content_Web20API_10">
		<cfoutput>
		...
		function _userDefinedContent(id, _fqServerName, js_CF_TEMPLATE_PATH, sCommunityEditionDownloadHref) {
			...
			try {
				switch (URLDecode(id)) {
					...
					case 'Web20API5':
						_data = content_Web20API_5;
					break;

					case 'Web20API6':
						_data = content_Web20API_6;
					break;

					case 'Web20API7':
						_data = content_Web20API_7;
					break;

					case 'Web20API8':
						_data = content_Web20API_8;
					break;

					case 'Web20API9':
						_data = content_Web20API_9;
					break;

					case 'Web20API10':
						_data = content_Web20API_10;
					break;
