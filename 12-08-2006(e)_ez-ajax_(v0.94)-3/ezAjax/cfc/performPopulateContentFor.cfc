													...
													<table width="100%" cellpadding="-1" cellspacing="-1">
														<tr>
															<td>
																...
																<a href="" title="This site has been determined to be 100 percent Safe from Hacker intrusions and is protected by our state-of-the-art anti-hacker protection system known as 'Hacker Dog'#cf_trademarkSymbol#." onmouseover="handleOnMouseOverLinkSpan('span_hackerSafe');" onmouseout="handleOnMouseOutLinkSpan('span_hackerSafe');" onclick="popUpWindowForHackerSafe(); return false;" style="color: black;"><span id="span_hackerSafe"><img src="app/images/Hacker Dog (small).gif" width="113" height="56" border="0"><br>(#DateFormat(Now(), "medium")# #TimeFormat(Now(), "short")#)</span></a>
																</span>
															</td>
															<td>
																	...
																	<td>
																		<table width="100%" cellpadding="1" cellspacing="1">
																			<tr>
																				...
																				<td valign="top">
																					<span class="normalx11TextClass">Free for personal use<br>(Personal Use requires a server name of <i>localhost</i> or <i>127.0.0.1</i><br><a href="" onclick="popUpWindowForCommunityEditionLicenseAgreement(); return false;">Community Edition License Agreement</a>).</span><br>
																				</td>
																			</tr>
																			<tr>
																				<td valign="top">
					...
					case 'performPopulateContentFor':
						if (IsDefined("qryStruct.namedArgs.aName")) {
							...
							switch (qryStruct.namedArgs.aName) {
								...
								case 'JSON Support':
									QuerySetCell(qObj, 'CONTENT', content_107_1a, qObj.recordCount);
								break;
