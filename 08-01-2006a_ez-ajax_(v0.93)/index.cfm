													...
													<tr>
														<td align="left" valign="top">
															<div id="div_debugContainer" style="display: none;">
																<a href="" title="Click this button to open the ezAJAX(tm) Debug Panel" onclick="handleEzAJAXDebugButtonClick(); return false;"><span class="onholdStatusBoldClass">ezAJAX:</span>&nbsp;
