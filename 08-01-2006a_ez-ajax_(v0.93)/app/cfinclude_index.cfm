...
<cffunction name="ContactUsFormHTML" access="public" returntype="string">
	...
	<cfsavecontent variable="html_ContactUsForm">
		<cfoutput>
			...
			<cfif (bool_optInOnly)>
				<span class="normalBoldBluePrompt">Opt-In for Monthly Newsletters</span>
			<cfelse>
				...
				<table width="100%" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td valign="top" align="left">
							...
							<a href="" target="_blank" onclick="popUpWindowForURL('#newsletter_url#', 'Newsletter', 800, 550, true); return false;">July 2006 Newsletter</a>&nbsp;|&nbsp;
							<a href="" target="_blank" onmouseover="handleOnMouseOverHackerSafe();" onmouseout="handleOnMouseOutHackerSafe();" onclick="popUpWindowForURL(window.location.protocol + '//' + window.location.hostname + '/app/hackerSafe.html', 'hackerSafe', 700, 550, false, true); return false;" style="color: red;"><span id="span_hackerSafe">Guaranteed Hacker Safe (#DateFormat(Now(), "medium")# #TimeFormat(Now(), "short")#)</span></a>
							</span>
							<br>
						</td>
					</tr>
