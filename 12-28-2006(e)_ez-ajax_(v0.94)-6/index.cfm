...
<cfif (NOT debugJavaScriptPackager)>
		...
		<div id="#Request.cf_div_floating_debug_menu#" style="display: <cfif (bool_isServerProduction)>none<cfelse>inline</cfif>; height: 25px; background-color: ##80FFFF; border: thin solid Black; z-index: 65535;">
