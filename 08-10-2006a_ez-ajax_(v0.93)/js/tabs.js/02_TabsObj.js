...
ezTabsObj.prototype = {
	...
	renderSubTabsFrom : function(anAR) {
		...
		html += '<table width="100%" cellpadding="-1" cellspacing="-1" onmouseover="this.border=0; return false;" onmouseout="this.border=1; return false;">'; // ezTabsObj.hideSubTabs(' + tabId + '); 
