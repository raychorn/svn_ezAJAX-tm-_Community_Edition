...
ezTabsObj.prototype = {
	...
	//	html += '<div id="div_outer_' + anchorID + '" style="background-color: #e9e7e7; border-top: thin solid silver; border-bottom: thin solid silver;">';

		html += '<a id="' + anchorID + '_L" name="' + anchorID + '_L">&nbsp;</a>';
		
	//	html += '<img src="/images/butnotactive_left.gif" align="middle" border="0">';
	...
	//	html += '<img src="/images/butnotactive_right.gif" align="middle" border="0">';
