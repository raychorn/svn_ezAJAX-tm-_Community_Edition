...
<cfoutput>
	...
	<cfscript>
		...
		_urlWaferAnalysis = Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/' & Request.scriptFirst & 'samples/semiconductors/wafer-analysis/index.cfm') & '?sessID=#Session.sessID#';
...
<cfif 0>
	...
	//			ezAlert('_NAME = [' + _NAME + ']' + ', _DIRECTORY = [' + _DIRECTORY + ']' + ', _TYPE = [' + _TYPE + ']');
