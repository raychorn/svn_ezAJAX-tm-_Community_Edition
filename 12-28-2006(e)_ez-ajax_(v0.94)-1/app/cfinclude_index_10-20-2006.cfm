...
<cfif 0>
function _handle_DynamicCodeInitiator_handleGetRegistrationData(_emailAddress, _serverName) { _emailAddress = (((typeof _emailAddress) == const_string_symbol) ? _emailAddress : ' '); _serverName = (((typeof _serverName) == const_string_symbol) ? _serverName : ' '); oAJAXEngine.doAJAX('performGetRegistrationData', 'handleGetRegistrationData', 'emailAddress', _emailAddress, 'serverName', _serverName); }; function handle_DynamicCodeInitiator_handleGetRegistrationData() { if (cache_processDynamicCodeTracker[handle_DynamicCodeInitiator_handleGetRegistrationData] != null) { clearInterval(cache_processDynamicCodeTracker[handle_DynamicCodeInitiator_handleGetRegistrationData]); cache_processDynamicCodeTracker[handle_DynamicCodeInitiator_handleGetRegistrationData] = null; stack_processDynamicCodeTracker.pop(); }; try { _handle_DynamicCodeInitiator_handleGetRegistrationData(oInput1.value, oInput2.value); } catch (e) { ezAlertError(ezErrorExplainer(e)); }; }; function boolIsModuleLoaded_handleGetRegistrationData() { return true; }; 

if (global_previouslyLoadedObjects.indexOf('/app/js/handleGetRegistrationData.js') != -1) { try { _handle_DynamicCodeInitiator_handleGetRegistrationData(oInput1.value, oInput2.value); } catch (e) { ezAlertError(ezErrorExplainer(e)); }; } else { ezDynamicObjectLoader(ezAJAXEngine.$[0]._url + '/app/js/handleGetRegistrationData.js'); processDynamicCodeTracker(handle_DynamicCodeInitiator_handleGetRegistrationData, boolIsModuleLoaded_handleGetRegistrationData); }
</cfif>
	...
	<cfsavecontent variable="jsCodeStore0">
		...
		oAJAXEngine.createAJAXEngineCallback = function () { adjustFloatingMenuStyles(); if (!bool_isServerProduction) { populateExtraMenuContainer(); } this.top = '400px'; };
												...
												<table width="100%" border="0" cellpadding="-1" cellspacing="-1">
													<tr>
														<td width="870" valign="top">
															<iframe id="iframe_siteMenuUsingDojo" width="870" frameborder="0" scrolling="No" src="app/siteMenu.html"></iframe>  <!---  style="position: absolute; top: 100px; left: 0px;" --->
														</td>
...
<cfif 0>
	<script language="JavaScript1.2" type="text/javascript">
		var aAnchorImageLogoRight = ezAnchorPosition.get$('anchor_imageLogoRight'); 
		if (!!aAnchorImageLogoRight) { 
			var oFishEye = ezFishEyeMenuObj.get$(aAnchorImageLogoRight.y, aAnchorImageLogoRight.x - 900, 900, 100);
