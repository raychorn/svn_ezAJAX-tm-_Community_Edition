...
This product currently supports Windows 2003, Windows 2000 or Windows XP.  Contact our Support Department (<a id="anchor_displayContactUs_#_uuid1023#" name="anchor_displayContactUs_#_uuid1023#" href="" onclick="displayContactUsContentIn(this.id, 'div_contactSupportContent_#_uuid1023#', 'performContactUsAction', '#Request.supportEmailAddress#'); return false;">#Request.supportEmailAddress#</a>) if you wish to install this product using any other OS.
					</p>
				</td>
			</tr>
			<tr>
...
<cfsavecontent variable="content_107_1"> <!--- 107.1 --->
	<cfoutput>
		<table width="100%" cellpadding="-1" cellspacing="-1">
			<tr>
				<td>
					<h6 style="color: blue;">What's New ?</h6>
				</td>
			</tr>
			<tr>
				<td>
					<p align="justify" class="normalPrompt"><b>ezAJAX#cf_trademarkSymbol# Version 0.93 will include GUI Support for Tabbed Interfaces like the one you are interacting with now.</b></p>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
					<p align="justify" class="normalPrompt"><b>ezAJAX#cf_trademarkSymbol# Version 0.92 is now compatible with Dojo 0.3.1</b><br>
			...
			<tr>
				<td>
					<br>
					<h6 style="color: blue;">Coming Soon...</h6>
					<p align="justify" class="normalPrompt"><b>ezAJAX#cf_trademarkSymbol# will soon have an expanded Programmer's Guide complete with programming examples and a Tutorial Primer that explains how to use the ezAJAX#cf_trademarkSymbol# Framework.</b></p>
				</td>
			</tr>
		</table>
	</cfoutput>
...
<cfoutput>
	...
	<!--
		...
		if (bool_useAbsoluteServerBusyPositioning) {
			oAJAXEngine.ezAJAX_serverBusyCallback = function (cObj) { var oPos = ezAnchorPosition.get$('anchor_imageLogoRight'); if (!!oPos) { resizeOuterContentWrapper(ezClientWidth()); cObj.style.top = (oPos.y + (parseInt(this.ezAJAX_serverBusy_height.toString())) * 0.75) + 'px'; cObj.style.left = (oPos.x + (parseInt(this.ezAJAX_serverBusy_width.toString()) / 8)) + 'px'; ezAnchorPosition.remove$(oPos.id); } };
		} else {
			oAJAXEngine.ezAJAX_serverBusy_divName = 'div_ezajax_3d_logo';
			oAJAXEngine.ezAJAX_serverBusyCallback = function (cObj) { resizeOuterContentWrapper(ezClientWidth()); };
		}
		...
		function resizeOuterContentWrapper(_width) {
			...
			if (!!oObj) {
				if (_width < webLayout_fixedWidth) {
					oObj.width = webLayout_fixedWidth - 32;
				} else if (oObj.width < webLayout_fixedWidth) {
					oObj.width = Math.min(_width, webLayout_fixedWidth);
				}
			}
		}
...
//	ezAlert('qObj = [' + qObj + ']');
		...
		function content_108_1() {
			...
			html += '</td>';
			html += '<td>';
			html += '<span class="normalx11TextClass">Free for personal use (<a href="" onclick="popUpWindowForURL(js_urlCommunityEditionLicenseAgreement, \'CommunityEditionLicenseAgreement\', 800, 550); return false;">license</a>).</span>';
			html += '</td>';
			html += '</tr>';
			...
			html += '<br>';
			html += '<span class="normalx12StatusBoldClass"><a href="" onclick="popUpWindowForURL(js_urlCommunityEditionProgrammersGuide, \'CommunityEditionProgrammersGuide\', 800, 550); return false;">Programmer\'s Guide</a></span>';
			html += '</td>';
...
// add tabSystem here...
	...
	<cfsavecontent variable="_poweredHTML">
		<cfoutput>
			<p align="justify" class="normalPrompt">This Site is powered by #ezClusterLink# and #ezAJAXLink#.&nbsp;
			#ezClusterLink# makes 2 or more web servers into a single coherent web server using low-cost techniques.
			<br>
			#ezAJAXLink# shortens time to market for AJAX Apps.  Let us do all the work for you.
			<br>
	...
	<table id="table_outerContentWrapper" width="800" align="center" cellpadding="1" cellspacing="1" style="background-color: white;">
		<tr>
			<td width="*">
				<table width="100%" cellpadding="-1" cellspacing="-1">
					<tr>
					...
					<tr>
						<td valign="top" align="left">
							...
							<a id="anchor_displayOptIn_101" name="anchor_displayOptIn_101" href="" onclick="displayOptInContentIn(this.id, 'div_OptInContent', 'performOptInAction', '', (((browser_is_ff) || (browser_is_op)) ? -300 : 0)); return false;">Opt-In</a>&nbsp;|&nbsp;
							<a href="" target="_blank" onclick="popUpWindowForURL('#newsletter_url#', 'Newsletter', 800, 550); return false;">July 2006 Newsletter</a>
							</span>
							<br>
							<div id="div_OptInContent"></div>
						</td>
					</tr>
					<tr>
						<td valign="top" align="left">
