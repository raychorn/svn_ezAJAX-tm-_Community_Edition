...
//		oAJAXEngine.isXmlHttpPreferred = true;
		...
		function getTabbedContent() {
			...
			oTabSystem1.onActivateTabsCallback = function(iTab) { var _id = this.contentsCollection[this.tabsDict.getValueFor(iTab) - 1]; var oDiv = _$(_id); if (!!oDiv) { var s = ''; switch (iTab) { case 2: s = getTab2Content(); break; case 3: s = getTab3Content(); break; }; if (s.length > 0) { oDiv.innerHTML = s; }; }; };
