 ...
 <body>
	...
	<div id="table_outerContentWrapper" style="position: absolute; width: 900px; top: 0px; left: 0px;">
		<div class="ContentWrapper">
			<div id="div_ezajax_3d_logo"><button id="btn_menuBomb" class="buttonClass<?php print_r(ezIsBrowserIE() ? '' : 'FF'); ?>" onClick="clickBombButton(); return false;">Menu 1</button>&nbsp;<button id="btn_menuBook" class="buttonClass<?php print_r(ezIsBrowserIE() ? '' : 'FF'); ?>" onClick="clickBookButton(); return false;">Menu 2</button></div>
