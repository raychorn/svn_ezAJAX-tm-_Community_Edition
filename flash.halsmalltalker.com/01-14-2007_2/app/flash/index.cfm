...
//		oAJAXEngine.isXmlHttpPreferred = true;
		...
		function defaultDynamicNewsDataSet2(id, cat, subcat, url) {
			...
			_html += '<td><input id="input_FlashAJAXData2_CAT_' + id + '_1" class="textClass" size="12" maxlength="16" title="Enter the Category here - The Category is the main heading for the group of SubCategories; you may think of the Category as if it were the Main Menu item and the SubCategory as if it were the SubMenu item." value="' + cat + '"></td>';
			_html += '<td><input id="input_FlashAJAXData2_SUBCAT_' + id + '_2" class="textClass" size="12" maxlength="16" title="Enter the SubCategory here - The SubCategory is the heading for the URL; you may think of the SubCategory as if it were the SubMenu item that falls under each Category which is the Main Menu item." value="' + subcat + '"></td>';
			_html += '<td><input id="input_FlashAJAXData2_URL_' + id + '_3" class="textClass" size="12" maxlength="128" title="Enter the URL here - This URL can be any valid Internet URL." value="' + url + '"></td>';
			_html += '</tr>';
			return _html;
		}
