...
//		oAJAXEngine.isXmlHttpPreferred = true;
		...
		function getTab4Content() {
			var _html = '';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '<div style="margin-top: 50px;">' : '')
			_html += '<table width="100%"><tr><td bgcolor="silver"><p align="justify" style="font-size: medium;">Flash Game Demo :: Asteroids</p></td></tr><tr><td valign="top">' + getFlashContent('insaneroids', '/app/flash/insaneroids/asteroids.swf', 800, 500, 'black', 'high') + '</td><td valign="top"></td></tr></table>';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '</div>' : '')
			return _html;
		}
		...
		function getTab4SubTab7Content() {
			var _html = '';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '<div style="margin-top: 50px;">' : '')
			_html += '<table width="100%"><tr><td bgcolor="silver"><p align="justify" style="font-size: medium;">Flash Game Demo :: Pacman</p></td></tr><tr><td valign="top">' + getFlashContent('pacman', '/app/flash/pacman/pacman.swf', 800, 500, 'black', 'high') + '</td><td valign="top"></td></tr></table>';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '</div>' : '')
			return _html;
		}
		...
		function getTab4SubTab8Content() {
			var _html = '';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '<div style="margin-top: 50px;">' : '')
			_html += '<table width="100%"><tr><td bgcolor="silver"><p align="justify" style="font-size: medium;">Flash Game Demo :: Road Safety</p></td></tr><tr><td valign="top">' + getFlashContent('roadSafety', '/app/flash/roadSafety/car_game.swf', 800, 500, 'black', 'high') + '</td><td valign="top"></td></tr></table>';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '</div>' : '')
			return _html;
		}
		...
		function getTab4SubTab9Content() {
			var _html = '';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '<div style="margin-top: 50px;">' : '')
			_html += '<table width="100%"><tr><td bgcolor="silver"><p align="justify" style="font-size: medium;">Flash Game Demo :: Crusader</p></td></tr><tr><td valign="top">' + getFlashContent('crusader', '/app/flash/crusader/crusader.swf', 800, 500, 'black', 'high') + '</td><td valign="top"></td></tr></table>';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '</div>' : '')
			return _html;
		}
	...
	//		oTabSystem1.debugHeight(200);
			...
			iTabs = oTabSystem1.addTab('Flash Game Demos :: Asteroids Game');
			oTab = iTabs.pop();
			iContent = oTabSystem1.addContentForTab(oTab, '');
