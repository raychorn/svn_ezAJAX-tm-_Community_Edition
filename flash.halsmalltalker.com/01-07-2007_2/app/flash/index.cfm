...
//		oAJAXEngine.isXmlHttpPreferred = true;
		...
		function getTabbedContent() {
			...
			oTabSystem1.onActivateTabsCallback = function(iTab) { var oDiv = _$(this.contentsCollection[iTab - 1]); if (!!oDiv) { var s = ''; switch (iTab) { case 2: s = getTab1Content(); break; case 3: s = getTab2Content(); break; case 4: s = getTab3Content(); break; }; if (s.length > 0) { oDiv.innerHTML = s; }; }; };

			iTabs = oTabSystem1.addTab('Site Background');
			iTab1 = iTabs.pop();
			iContent = oTabSystem1.addContentForTab(iTab1, getTab0Content());
