...
//		oAJAXEngine.isXmlHttpPreferred = true;
		...
		function getTab5Content() {
			var _html = '';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '<div style="margin-top: 50px;">' : '')
			_html += '<table width="100%"><tr><td bgcolor="silver"><p align="justify" style="font-size: medium;">Flash Media Server 2 :: Cisco Presentation</p></td></tr><tr><td valign="top">This Presentation was delivered to Cisco Systems on 01-10-2007, <a href="/app/flash/Flash Media Server Presentation to Cisco 1-10-2007a/Flash Media Server Presentation to Cisco 1-10-2007a.htm" target="_blank">Click Here.</a></td><td valign="top"></td></tr></table>';
			_html += ((!ezAJAXEngine.browser_is_ie) ? '</div>' : '')
			return _html;
		}
