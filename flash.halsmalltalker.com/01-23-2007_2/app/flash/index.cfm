...
//		oAJAXEngine.isXmlHttpPreferred = true;
		...
		function getContentForFlash4MenuDemo() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlash4MenuDemo.cfm" target="_self">Flash 4 Menu Demo</a></p></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="Auto" width="100%" height="350" src="/app/flash/myIssueTrack/issueTrackOpening.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="Auto" width="100%" height="350" src="/app/flash/3.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlash4NavBarDemo() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlash4NavBarDemo.cfm" target="_self">Flash 4 NavBar Demo</a></p></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="Auto" width="200" height="850" src="/app/flash/simpleNavBar/simpleNavBar.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td><td valign="top"><span style="font-size: ' + bodyFontSize + ';">This Flash 4 Demo was designed originally to serve as a Nav Bar for a web site that no longer exists.<br><br>The value of this Demo is to show how directions and information can be conveyed to an end-user as they are using the functions of the Flash component.<br><br>Keep in mind this was done originally with Flash 4.<br><br><a href="/app/flash/simpleNavBar/simpleNavBar.fla" target="_blank">Click here to download the Flash Source File.</a></span></td></tr></table>';
			return _html;
		}
		
		function popUpDocumentForFlash4ProjectPlanDemo() {
			var aURL = '/app/flash/IssueTrack-Project-Plan/IssueTrack-Project-Plan.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#';
		...
		function getContentForFlash4ProjectPlanDemo() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlash4ProjectPlanDemo.cfm" target="_self">Flash 4 Project Plan Demo</a></p></td></tr><tr><td valign="top"><small>This Flash 4 project Plan was originally designed to demonstrate how a set of images could be wrapped-up into a Flash component.<br><br>Flash provides a nice way to stream content in a manner that tends to reduce the amount of bandwidth that is used to display traditional images.<br><br><a href="/app/flash/IssueTrack-Project-Plan/IssueTrack-Project-Plan.fla" target="_blank">Click here to download the Flash Source File.</a></small></td></tr><tr><td valign="top"><a href="" onclick="popUpDocumentForFlash4ProjectPlanDemo(); return false;">Click HERE to Launch the Demo</a></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlash4ProjectPlanDemo2() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlash4ProjectPlanDemo2.cfm" target="_self">Flash 4 Project Plan Demo 2</a></p></td></tr><tr><td valign="top">Keep in mind this Flash 4 Demo was originally designed for a specific purpose that no longer exists.<br><br><a href="/app/flash/IssueTrack-Project-Plan/IssueTrack-Project-PlanA.fla" target="_blank">Click here to download the Flash Source File.</a></td></tr><tr><td valign="top"><a href="" onclick="popUpDocumentForFlash4ProjectPlanDemo2(); return false;">Click HERE to Launch the Demo</a></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlash5DemosAJAX() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td align="center" class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlash5DemosAJAX.cfm" target="_self">Flash 5 Adverts Demo</a></p></td></tr><tr><td valign="top">' + getFlashContent('AdvertsClip1', '/app/flash/Adverts Movie/AdvertsClip1.swf', 468, 80, '##ffffff', 'high') + '</td></tr><tr><td valign="top"><span style="font-size: ' + bodyFontSize + ';">This Flash 5 Demo is not functional at this time other than to serve as a sample of the work that was done way back whenever this particular Flash 5 component was functional.<br><br>This Flash 5 component could have been brought up to date and made to work with the Flash Media Server 2.<br><br>The Flash Media Server could have provided the ability to track stats on the Adverts that were displayed as well as those Adverts that were clicked.<br><br>Flash Media Server could have been also used to pick the next Advert to be shown.<br><br><a href="/app/flash/Adverts Movie/AdvertsClip1.fla" target="_blank">Click here to download the Flash Source File.</a></span></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlash5DynamicNewsDemo() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader" colspan="2"><p align="justify" style="font-size: ' + headerFontSize + ';"><NOBR><a href="/app/flash/links/getContentForFlash5DynamicNewsDemo.cfm" target="_self">Flash 5 Dynamic News Demo</a></NOBR></p></td></tr><tr><td valign="top">' + getFlashContent('news-flash-headlines', '/app/flash/news-flash-headlines/news-flash-headlines.swf', 150, 600, '##ffffff', 'high') + '</td><td valign="top"><span style="font-size: ' + bodyFontSize + ';">This Flash 5 component is completely dynamic.  It reads the data that is displayed using a technique that was used long before Flash Remoting ever existed.<br><br>This proves the fact that Flash 5 was able to be data-driven using nothing more than the HTTP protocol which was quite inefficient as compared with Flash Media Server 2, for instance.<br><br>As you can see this instance of this Demo shows nothing more than the current Month and Year with no other data.<br><br><a href="/app/flash/news-flash-headlines/news-flash-headlines.fla" target="_blank">Click here to download the Flash Source File.</a></span></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlash5DynamicNewsDemoWithInteractiveAJAX() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader" colspan="2"><p align="justify" style="font-size: ' + headerFontSize + ';"><NOBR><a href="/app/flash/links/getContentForFlash5DynamicNewsDemoWithInteractiveAJAX.cfm" target="_self">Flash 5 Dynamic News Demo with Interactive AJAX</a></NOBR></p></td></tr><tr><td valign="top"><div id="div_Flash5_DynamicNewsDemo_with_AJAX2"></div></td><td valign="top"><span style="font-size: ' + bodyFontSize + ';">This time we will use AJAX to interactively create the dataset that will be transmitted to the Flash 5 component.  We have already seen how a Flash 5 component can grab data from a web server but demo shows how AJAX can be used to create the dataset which will then be fetched by the Flash 5 component.<br><br>Click this button --> <button id="btn_buildDynamicNewsDataSet2" class="buttonClass" style="' + ((!ezAJAXEngine.browser_is_ie) ? 'font-size: 9px;' : '') + '" onclick="this.disabled = true; buildFlashAJAXData2(); return false;">[Build Data Set]</button> to begin the process of interactively building the dataset using AJAX.<br><br>Once the data set has been created and the Flash component has been displayed this will prove it is possible to use AJAX with Flash to dynamically create data for a data-driven Flash component.  The data you will build using AJAX will be stored in the Session, your Session, on the Server.  By using the Session as a temporary storage container we achieve a level of physical security that keeps other users who may be using this same Demo at the same time you are from being able to access your data.<br><br>Also keep in mind this Demo will use DHTML to populate a &lt;DIV&gt;&lt;/DIV&gt; tag with a live Flash component.<br><br><a href="/app/flash/news-flash-headlines3/news-flash-headlines3.fla" target="_blank">Click here to download the Flash Source File.</a></span><br><br><div id="div_Flash5_DynamicNewsDemo_with_AJAX_desc" style="border: solid thin silver; font-size: ' + bodyFontSize + '">This block of text will be replaced dynamically AFTER you click that button.</div></td></tr></table>';
			return _html;
		}
		
		function getContentForRepublishedFlashGames() {
			var _html = '';
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForRepublishedFlashGames.cfm" target="_self">Republished Flash Games</a>&nbsp;<small></small></p></td></tr><tr><td valign="top"><small>The Flash Games that appear under this tab are all being republished from a source other than that which owns the rest of this site.  In each instance there is a disclaimer on those games that were not produced by the owner of this site and under no circumstances is any undue credit being taken for anything more than the added features that was added to each game.  The fact remains that features were added to these games that results in more functionality than existed in the original games and the credit for the additional features does not lie with the original authors of these games.</small></td><td valign="top"></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlashAsteroidsGame() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlashAsteroidsGame.cfm" target="_self">Flash Game Demo :: Asteroids</a>&nbsp;<small><a href="/app/flash/insaneroids/insaneroids.zip" title="This source requires a proprietary Flash development system you may not already have." target="_blank">Download</a></small></p></td></tr><tr><td valign="top"><small>What makes this version of the 3DFA Flash Sample unique?  The fact that if you Register for and Login using a Player Account at this site you can track your High Scores and play against others who also enjoy this game.</small></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="No" width="820" height="650" src="/app/flash/insaneroids/AsteroidsDispatcher.cfm?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td><td valign="top"></td></tr></table>';
			return _html;
		}
		...
		function getContentForPacmanGame() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForPacmanGame.cfm" target="_self">Flash Game Demo :: Pacman</a>&nbsp;<small><a href="/app/flash/pacman/pacman.zip" title="This source requires a proprietary Flash development system you may not already have." target="_blank">Download</a></small></p></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="Auto" width="800" height="500" src="/app/flash/pacman/pacman.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td><td valign="top"></td></tr></table>';
			return _html;
		}
		...
		function getContentForRoadSafetyGame() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForRoadSafetyGame.cfm" target="_self">Flash Game Demo :: Road Safety</a>&nbsp;<small><a href="/app/flash/roadSafety/roadSafety.zip" title="This source requires a proprietary Flash development system you may not already have." target="_blank">Download</a></small></p></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="Auto" width="800" height="500" src="/app/flash/roadSafety/car_game.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td><td valign="top"></td></tr></table>';
			return _html;
		}
		...
		function getContentForCrusaderGame() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForCrusaderGame.cfm" target="_self">Flash Game Demo :: Crusader</a>&nbsp;<small><a href="/app/flash/crusader/crusader.zip" title="This source requires a proprietary Flash development system you may not already have." target="_blank">Download</a></small></p></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="Auto" width="800" height="500" src="/app/flash/crusader/crusader.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td><td valign="top"></td></tr></table>';
			return _html;
		}
		...
		function getContentForArriveAliveGame() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForArriveAliveGame.cfm" target="_self">Flash Game Demo :: Arrive Alive</a>&nbsp;<small><a href="/app/flash/arrive alive/arrive alive.zip" title="This source requires a proprietary Flash development system you may not already have." target="_blank">Download</a></small></p></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="Auto" width="800" height="500" src="/app/flash/arrive alive/big_day_out.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td><td valign="top"></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlashMediaServer2() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlashMediaServer2.cfm" target="_self">Flash Media Server 2 :: Cisco Presentation</a>&nbsp;<small><a href="/app/flash/Flash Media Server Presentation to Cisco 1-10-2007a/Flash Media Server Presentation to Cisco 1-10-2007a.zip" target="_blank">Download</a></small></p></td></tr><tr><td valign="top"><span style="font-size: ' + bodyFontSize + ';">This Presentation was delivered to Cisco Systems on 01-10-2007, <a href="/app/flash/Flash Media Server Presentation to Cisco 1-10-2007a/Flash Media Server Presentation to Cisco 1-10-2007a.htm" target="_blank">Click Here.</a></span></td><td valign="top"></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlash8Promo() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlash8Promo.cfm" target="_self">Flash 8 Promo for www.ez-ajax.com</a>&nbsp;<small><a href="/app/flash/ez-ajax-promo/ez-ajax-promo.zip" title="This source requires a proprietary Flash development system you may not already have." target="_blank">Download</a></small></p></td></tr><tr><td valign="top" bgcolor="##0060E0"><iframe frameborder="0" scrolling="Auto" width="450" height="250" src="/app/flash/ez-ajax-promo/ezajax_logo.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td></tr><tr><td valign="top"><span style="font-size: ' + bodyFontSize + ';">This Flash 8 Promo was created to promote the ezAJAX Site.  It was coded using a proprietary technique that allows for Rapid Development of Flash components that can be quite complex using very little development time.  As you can see this is a very professional looking Flash 8 component.<br><br>The games posted to this site were also created using this same proprietary programming technique.  Programmers and non-programmers alike can use this same proprietary programming technique with little effort and very little training.</span></td></tr></table>';
			return _html;
		}
		...
		function getContentForFlex15Demo() {
			...
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlex15Demo.cfm" target="_self">Flex 1.5 Demo</a></p></td></tr><tr><td valign="top"><span style="font-size: ' + bodyFontSize + ';">This Flex 1.5 Demo was originally created for one of my clients and was designed to act as an Intranet portal for their internal operations center.  The Database is brought to you by a 64-bit SQL Server 2005 running on a Dual Core 64-bit AMD 4200+ running 64-bit Windows 2003 R2 with 4 GB RAM.<br><br>This Flex 1.5 Demo makes heavy use of ActionScript which by the by is pretty much the same as JavaScript in terms of programming.  ActionScript code can be interchanged with JavaScript for the code that can be consumed by your typical Flex 1.5 Application and your browser.  The ability to interchange and reuse ActionScript with JavaScript makes it possible to reduce your programming effort and maintenance.   Flex 1.5 programming is not for the weak of heart where ActionScript is concerned as it can take some time to achieve the same levels of complexity and functionality your typical JavaScript programmer may be familiar with for web programming.<br><br>Flex 1.5 is built into ColdFusion MX 7 although for some odd reason almost nobody at Adobe would confirm this.  Take a close look at the API for Flex 1.5 and whether or not the Flex 1.5 API can be used by the flavor of Flash ColdFusion MX 7 knows how to generate for you as well as the tag language one uses to create Flash components using ColdFusion MX 7 and you too may come to realize Flex 1.5 or a variant thereof was embedded into ColdFusion MX 7 because this seems to be the case.</span></td></tr><tr><td valign="top"><a href="" onclick="popUpWindowForURL(\'http://www.ez-ajax.com/flex-demo/index.html\', \'Flex15Demo\'); return false;">Click HERE to Launch the Flex 1.5 Demo</a></td></tr></table>';
			return _html;
		}
		
		function getContentForFlashGamingSupport() {
			var _html = '';
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlashGamingSupport.cfm" target="_self">Flash Gaming Support</a></p></td></tr><tr><td valign="top"><span style="font-size: ' + bodyFontSize + ';">Here are some various Flash Gaming Support files you may download at your liesure.<br><br><a href="/app/flash/downloads/Login+Register_templateClip.zip" target="_blank">Login/Register Movie Clip with ColdFusion MX 7 Code (338 Kb)</a></span></td></tr></table>';
			return _html;
		}
		
		function getContentForFlashTowersOfHanoi() {
			var _html = '';
			var headerFontSize = ((!ezAJAXEngine.browser_is_ie) ? '15px' : '13px');
			var bodyFontSize = (parseInt(headerFontSize) - 2) + 'px';
			_html += '<table width="590"><tr><td class="primaryContentContainerHeader"><p align="justify" style="font-size: ' + headerFontSize + ';"><a href="/app/flash/links/getContentForFlashTowersOfHanoi.cfm" target="_self">Flash Towers Of Hanoi :: Classic Computer Science Project</a></p></td></tr><tr><td valign="top"><iframe frameborder="0" scrolling="No" width="650" height="450" src="/app/flash/towersOfHanoiFlash/towersofhanoi.html?nocache=#RandRange(1, 65535, 'SHA1PRNG')#"></iframe></td></tr></table>';
			return _html;
		}
		...
		function _dispatchContentFor(someContent) {
			var oDiv = _$('div_primaryContentContainer');
			someContent = ((someContent == null) ? '' : someContent);
			if (!!oDiv) {
				oDiv.innerHTML = someContent;
			}
		}
		
		function dispatchContentFor(aFunc) {
			if ((typeof aFunc) == const_function_symbol) {
				try { _dispatchContentFor(aFunc()); } catch (e) { ezAlertError('Error in dispatchContentFor()\n' + ezErrorExplainer(e)); };
			}
		}
		...
		global_tabsContentCallBackDispatchAR['Republished Flash Games'] = getContentForRepublishedFlashGames;

		global_tabsContentCallBackDispatchAR['Asteroids Game'] = getContentForFlashAsteroidsGame;
		...
		global_tabsContentCallBackDispatchAR['Flash Gaming Support'] = getContentForFlashGamingSupport;
		
		global_tabsContentCallBackDispatchAR['Flash Towers of Hanoi'] = getContentForFlashTowersOfHanoi;
		
		function getContentFromLink(_linkName) {
			var someContent = '';
			var fX = -1;
			try { fX = eval(_linkName); } catch (e) { };
			try { someContent = (( (_linkName.length > 0) && ((typeof fX) == const_function_symbol) ) ? fX() : ''); } catch (e) { };
			return someContent;
		};
		
		function navigateToHome() {
			dispatchContentFor(getContentForSiteBackground);
		}
		
		function navigateToFlash4() {
			dispatchContentFor(getContentForFlash4EmailerDemo);
		}

		function navigateToFlash5() {
			dispatchContentFor(getContentForFlash5DemosAJAX);
		}

		function navigateToFlash8() {
			dispatchContentFor(getContentForFlash8Promo);
		}

		function navigateToFlex15() {
			dispatchContentFor(getContentForFlex15Demo);
		}

		function navigateToGames() {
			dispatchContentFor(getContentForFlashGamingSupport);
		}

		function navigateToDocs() {
			dispatchContentFor(getContentForFlashMediaServer2);
		}

		function navigateToFlash4MenuDemo() {
			dispatchContentFor(getContentForFlash4MenuDemo);
		}

		function navigateToFlash4NavDemo() {
			dispatchContentFor(getContentForFlash4NavBarDemo);
		}

		function navigateToFlash4DocDemo1() {
			dispatchContentFor(getContentForFlash4ProjectPlanDemo);
		}

		function navigateToFlash4DocDemo2() {
			dispatchContentFor(getContentForFlash4ProjectPlanDemo2);
		}
		</cfoutput>
	</cfsavecontent>
	...
	<div id="table_outerContentWrapper" style="position: absolute; width: 900px; top: <cfif (NOT bool_isServerProduction)>25<cfelse>0</cfif>px; left: 0px;">
		<cfif 0>
		<DIV class="titleWrapper">
			<DIV id=e1 style="position: absolute; left: 200px;">
				<img src="/app/flash/images/blueBoxClearCorner.gif" width="78" height="75">
			</DIV>
			<DIV id=e2 style="position: absolute; left: 278px; WIDTH: 522px;">
				<img src="/app/flash/images/neuronMatrix_blue.jpg" width="522" height="75">
			</DIV>
			<DIV id=e3 style="position: absolute; top: 20px; left: 220px; WIDTH: 420px; HEIGHT: 35px">
		...
		<div class="ContentWrapper">
			...
			<div class="twoColumnRight" style="float: left; <cfif (NOT Request.commonCode.ezIsBrowserIE())>margin-left: 30px;</cfif>">
				<img src="/app/flash/images/flashSiteHeader.jpg" width="590" height="100" border="0">
				<div id="div_ezajax_3d_logo"></div>
				<a id="anchor_imageLogoRight" name="anchor_imageLogoRight"></a>
				<br>
				<div id="div_primaryContentContainer" style="border: 1px solid silver;">
	...
	<script language="JavaScript1.2" type="text/javascript">
		if (js_linkName.length == 0) {
			navigateToHome();
		} else {
			_dispatchContentFor(getContentFromLink(js_linkName));
		}
	</script>
</cfoutput>
