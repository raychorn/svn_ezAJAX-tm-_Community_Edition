...
//		oAJAXEngine.isXmlHttpPreferred = true;
		...
		function navigateToFlash5DynamicDemo1() {
			dispatchContentFor(getContentForFlash5DynamicNewsDemo);
		}

		function navigateToFlash5AjaxDemo1() {
			dispatchContentFor(getContentForFlash5DynamicNewsDemoWithAJAX);
		}

		function navigateToFlash5AjaxDemo2() {
			dispatchContentFor(getContentForFlash5DynamicNewsDemoWithInteractiveAJAX);
		}
		</cfoutput>
	</cfsavecontent>
