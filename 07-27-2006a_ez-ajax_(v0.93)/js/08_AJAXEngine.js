...
ezAJAXEngine.initDebugMenu = function(ajaxObj) {
	if (!!ajaxObj) {
		...
		if ( (!!oDiv) && (bool_canShowScopesMenu) ) {
			oDiv.innerHTML = '<span class="onholdStatusBoldClass">Scopes:</span>&nbsp;<button name="btn_helperPanel2" id="btn_helperPanel2" class="buttonMenuClass' + (((browser_is_ff) || (browser_is_ns)) ? 'FF' : '') + '" title="Click this button to open the Scopes Debug Panel" onclick="handle_ajaxHelper2_onClick(); return false;">[>>]</button>';
		}
