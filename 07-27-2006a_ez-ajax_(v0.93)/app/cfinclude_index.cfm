...
<cfsavecontent variable="content_104_10"> <!--- 104.10 --->
	<cfoutput>
(10). The ezAJAX#cf_trademarkSymbol# Community Edition supports any version of ColdFusion MX 7 using any web server supported by ColdFusion MX 7.  Be sure to let our Support Department (<a id="anchor_displayContactUs_#_uuid10#" name="anchor_displayContactUs_#_uuid10#" href="" onclick="displayContactUsContentIn(this.id, 'div_contactSupportContent_#_uuid10#', 'performContactUsAction', '#Request.supportEmailAddress#'); return false;">#Request.supportEmailAddress#</a>) know if you encounter anything that differs from this.
	</cfoutput>
</cfsavecontent>
...
This product currently supports Windows 2003, Windows 2000 or Windows XP.  Contact our Support Department (<a id="anchor_displayContactUs_#_uuid1023#" name="anchor_displayContactUs_#_uuid1023#" href="" onclick="displayContactUsContentIn(this.id, 'div_contactSupportContent_#_uuid1023#', 'performContactUsAction', '#Request.supportEmailAddress#'); return false;">#Request.supportEmailAddress#</a>) if you wish to install this product using a different OS than the ones we currently support.  If there is enough interest we may support other OS's than those currently supported.
					</p>
				</td>
			</tr>
			<tr>
...
<cfsavecontent variable="content_101_2"> <!--- 101.2 --->
	<cfoutput>
		...
		<br>
		<span class="normalx12StatusBoldClass"><a id="anchor_displayContactUs_101" name="anchor_displayContactUs_101" href="" onclick="displayContactUsContentIn(this.id, 'div_contactUsContent', 'performContactUsAction', '#Request.salesEmailAddress#'); return false;">#Request.salesEmailAddress#</a></span>
		<div id="div_contactUsContent"></div>
		</td>
		<td align="left" valign="top" style="border-top: thin solid Blue;">
		<span class="titlex14BoldClass">Investors, Contact Us.</span>
		<br>
		<span class="normalx12StatusBoldClass"><a id="anchor_displayContactUs_102" name="anchor_displayContactUs_102" href="" onclick="displayContactUsContentIn(this.id, 'div_contactUsContent', 'performContactUsAction', '#Request.investorRelationsEmailAddress#'); return false;">#Request.investorRelationsEmailAddress#</a></span>
		</td>
		<td align="left" valign="top" style="border-top: thin solid Blue;">
		<span class="titlex14BoldClass">Affiliates, Contact Us. (10%-60% Comissions Paid)</span>
		<br>
		<span class="normalx12StatusBoldClass"><a id="anchor_displayContactUs_103" name="anchor_displayContactUs_103" href="" onclick="displayContactUsContentIn(this.id, 'div_contactUsContent', 'performContactUsAction', '#Request.affiliateRelationsEmailAddress#'); return false;">#Request.affiliateRelationsEmailAddress#</a></span>
		</td>
		</tr>
		</table>
	</cfoutput>
						...
						<tr>
							<td width="50%" valign="top">
								<table width="100%" cellpadding="-1" cellspacing="-1">
									...
									<tr>
										<td>
											<p align="justify">Enter the EMail Address and Server Name you used when you Installed your copy of ezAJAX#cf_trademarkSymbol#. <a id="anchor_productDownload5" href="" target="_blank" onclick="clickProductDownloadAnchor(this.id); return true;">Download the ezAJAX#cf_trademarkSymbol# Installer program</a> and Install ezAJAX#cf_trademarkSymbol# to get your Runtime License for your 30-day Trial and then return here to Manage your Runtime Licenses.</p>
			...
			//		var _hRef = ezFilePath2HrefUsingCommonFolder(bName, hRef, cFolder);
					...
					if (!jsBool_isCurrentBlogDefault) {
						if (_hRef.toUpperCase().indexOf('.EXE') > -1) {
							sCommunityEditionDownloadHref = _hRef.ezClipCaselessReplace('\\', '/');
						}
...
//	ezAlert('qObj = [' + qObj + ']');
		...
		function getEzAJAXProductContent() {
			...
			iContent = oTabSystem1.addContentForTab(iTabs.pop(), populateSiteContent(101.1, true));

			iTabs = oTabSystem1.addTab('How to Install ezAJAX' + js_trademarkSymbol);
			howToInstallTab = iTabs.pop();
			iContent = oTabSystem1.addContentForTab(howToInstallTab, populateSiteContent(101.3, true));

			iTabs = oTabSystem1.addTab('ezAJAX' + js_trademarkSymbol + ' Features');
			iContent = oTabSystem1.addContentForTab(iTabs.pop(), populateSiteContent(105.1, true));

			iTabs = oTabSystem1.addTab('ezAJAX' + js_trademarkSymbol + ' Licenses');
			iContent = oTabSystem1.addContentForTab(iTabs.pop(), populateSiteContent(106.1, true));
			...
			iContent = oTabSystem1.addContentForTab(iTabs.pop(), populateSiteContent(108.1, true) + html);
			html = '';

			iTabs = oTabSystem1.addTab('Sample Apps');
			iContent = oTabSystem1.addContentForTab(iTabs.pop(), '<table width="100%" border="1" bordercolor="blue" cellpadding="-1" cellspacing="-1"><tr><td valign="top">' + sampleDojoAppsPod() + '</td><td valign="top">' + sampleAJAXAppsPod() + '</td></tr></table>');

			iTabs = oTabSystem1.addTab('Contact Us');
			iContent = oTabSystem1.addContentForTab(iTabs.pop(), populateSiteContent(101.2, true));
									...
									<td width="100%" align="left" valign="top">
										...
										<cfelse>
											<table width="100%" border="0" cellpadding="-1" cellspacing="-1">
												<tr>
													<td width="700">
														<a href="http://www.ez-ajax.com"><img src="app/images/ezAJAX-banner_800x90.jpg" width="800" border="0"></a>
													</td>
													<td width="*">
