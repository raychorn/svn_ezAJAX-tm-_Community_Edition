		...
		<cfsavecontent variable="someContent">
			<cfoutput>
				...
				<cfloop index="_i" from="1" to="#nItems#">
					...
					<cfset xxAR[ArrayLen(xxAR) + 1] = "boolFlag = [#boolFlag#] (#anItem#) [#_jscode#]">
					<cfif (FindNoCase("/api.js/", anItem) eq 0)>
						<cfset bool_handledByJAPI = (ListFindNoCase("00_ezElementPositonX.js,00_ezElementPositon.js,00_getSelectionsFromObj.js,01_clickRadioButton.js,01_clientHt$.js,01_clientWid$.js,09_window_onload.js,01_disableAllButtonsLike.js,01_events.js", ListLast(anItem, "/"), ",") gt 0)>
						<cfif (bool_handledByJAPI)>
							<cfscript>
