		...
		<table width="90%" cellpadding="-1" cellspacing="-1">
			...
			<tr>
				...
				<tr>
					...
					<td>
						<span class="workingStatusClass">The following sites are using ezAJAX and ezCluster:&nbsp;<a href="http://flash.ez-ajax.com" target="_blank">http://flash.ez-ajax.com</a> and <a href="http://ezcluster.ez-ajax.com" target="_blank">http://ezcluster.ez-ajax.com</a></span>
					</td>
				</tr>
			</tr>
		</table>
...
// +++
	...
	//		oTabSystem1.isHandleBrowserBackForwardBtns = true;
			oTabSystem1.onActivateTabsCallback = function(iTab) { iTab = parseInt(iTab.toString()); if (iTab > 1) {  }; }; // var cDivName = oTabSystem1.contentsCollection[iTab - 1]; var oDiv = _$(cDivName); if ( (!!oDiv) && (oDiv.innerHTML.length == 0) ) { ezAJAXEngine.$[0].doAJAX('performPopulateClickMenuTab', 'handlePerformPopulateClickMenuTab', 'iTab', iTab); } else { oTabSystem1._activateTab(iTab); };
	...
	<DIV id=centerwrapper style="position: absolute; width: 900px; top: 0px; left: 0px;">
		<DIV id=e0 style="LEFT: 1px; WIDTH: 900px; POSITION: absolute; TOP: 0px; HEIGHT: 130px">
			<IMG height=130 alt="" src="/app/images/sitebuilder/blue_header-760x130.jpg" width=910>
		</DIV>
		<DIV id=e1 style="LEFT: 1px; WIDTH: 900px; POSITION: absolute; TOP: 130px; left: 15px; HEIGHT: 452px;  z-index: 32767;">
			<!--- +++ --->
		...
		<cfif 0>
			<DIV id=e2 style="LEFT: 1px; WIDTH: 150px; POSITION: absolute; TOP: 130px; HEIGHT: 600px; z-index: 1;">
				<IMG height=600 src="/app/images/sitebuilder/blueComputerNavigationBox.jpg" width=150>
			</DIV>
			<DIV id=e3 style="LEFT: 700px; WIDTH: 204px; POSITION: absolute; TOP: 130px; HEIGHT: 600px; z-index: 1;">
				<IMG height=600 src="/app/images/sitebuilder/grayKeyboardTop.gif" width=200>
			</DIV>
		</cfif>
