 ...
 <head>
  ...
  <script language="JavaScript1.2" type="text/javascript">
		...
		function disableAllButtons() {
  		...
  		function _clickPreloaderButton(btnId, sContent) {
		...
		function clickPreloaderOneButton() {
			return _clickPreloaderButton('btn_preloaderOne', '<?php print_r(flashContent('loadingGearsPreloader', 200, 100, '/app/flash/preloaders/loading-gears-preloader.swf', '#164f9f')); ?>');
		}

		function clickPreloaderTwoButton() {
			return _clickPreloaderButton('btn_preloaderTwo', '<?php print_r(flashContent('loadingGearsPreloader2', 200, 100, '/app/flash/preloaders/loading-gears-preloader2.swf', '#164f9f')); ?>');
		}
  </script>
 </head>
 <body>
