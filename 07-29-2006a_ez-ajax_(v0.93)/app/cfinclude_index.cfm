...
<cfsavecontent variable="content_101_2"> <!--- 101.2 --->
	<cfoutput>
		...
		<br>
		<span class="normalx12StatusBoldClass"><a id="anchor_displayContactUs_101" name="anchor_displayContactUs_101" href="" onclick="displayContactUsContentIn(this.id, 'div_contactUsContent', 'performContactUsAction', '#Request.salesEmailAddress#', (((browser_is_ff) || (browser_is_op)) ? -300 : 0)); return false;">#Request.salesEmailAddress#</a></span>
		<div id="div_contactUsContent"></div>
		</td>
		<td align="left" valign="top" style="border-top: thin solid Blue;">
		<span class="titlex14BoldClass">Investors, Contact Us.</span>
		<br>
		<span class="normalx12StatusBoldClass"><a id="anchor_displayContactUs_102" name="anchor_displayContactUs_102" href="" onclick="displayContactUsContentIn(this.id, 'div_contactUsContent', 'performContactUsAction', '#Request.investorRelationsEmailAddress#', (((browser_is_ff) || (browser_is_op)) ? -300 : 0)); return false;">#Request.investorRelationsEmailAddress#</a></span>
		</td>
		<td align="left" valign="top" style="border-top: thin solid Blue;">
		<span class="titlex14BoldClass">Affiliates, Contact Us. (10%-60% Commissions Paid)</span>
		<br>
		<span class="normalx12StatusBoldClass"><a id="anchor_displayContactUs_103" name="anchor_displayContactUs_103" href="" onclick="displayContactUsContentIn(this.id, 'div_contactUsContent', 'performContactUsAction', '#Request.affiliateRelationsEmailAddress#', (((browser_is_ff) || (browser_is_op)) ? -300 : 0)); return false;">#Request.affiliateRelationsEmailAddress#</a></span>
		</td>
		</tr>
		</table>
	</cfoutput>
...
<cfsavecontent variable="content_107_1"> <!--- 107.1 --->
	<cfoutput>
		<table width="100%" cellpadding="-1" cellspacing="-1">
			<tr>
				<td>
					<h4 style="color: blue;">What's New ?</h4>
				</td>
			</tr>
			<tr>
				<td>
					<b>ezAJAX#cf_trademarkSymbol# Version 0.93 will include GUI Support for Tabbed Interfaces like the one you are interacting with now.</b>
					<br><br>
				</td>
			</tr>
			<tr>
					...
					<table width="100%" cellpadding="-1" cellspacing="-1">
						<tr>
							...
							<td width="*" valign="middle">
								ezAJAX#cf_trademarkSymbol# is currently being featured at <a href="http://www.tucows.com/preview/504416" target="_blank">TuCows</a>.
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td>
					<br>
					<b>ezAJAX#cf_trademarkSymbol# Version 0.92 is now compatible with Dojo 0.3.1</b><br>
			...
			<tr>
				<td>
					...
					<b>ezAJAX#cf_trademarkSymbol# will soon have an expanded Programmer's Guide complete with programming examples and a Tutorial Primer that explains how to use the ezAJAX#cf_trademarkSymbol# Framework.</b><br>
				</td>
			</tr>
		</table>
	</cfoutput>
						...
						<tr>
							<td width="50%" valign="top">
								<table width="100%" cellpadding="-1" cellspacing="-1">
									...
									<tr>
										<td align="left">
											&nbsp;<span class="normalPrompt"><b>Email Address:</b></span>&nbsp;<input type="text" id="manageLicenses_emailAddress" class="textClass" tabindex="1" size="30" maxlength="255" value="" onkeyup="if (!!validateManageLicensesUserEmailAddrs()) { validateManageLicensesUserEmailAddrs() }; simulateEnterKeyForManageLicensesActions(event);"><br>
											&nbsp;<span class="normalPrompt"><b>Server Name:</b></span>&nbsp;<input type="text" id="manageLicenses_serverName"  class="textClass" tabindex="2" size="50" maxlength="255" value="" onkeyup="simulateEnterKeyForManageLicensesActions(event);"><br>
...
//	ezAlert('qObj = [' + qObj + ']');
		...
		function content_108_1() {
			...
			html += '</td>';
			html += '<td>';
			html += '<span class="normalx11TextClass">Free for personal use (<a href="" onclick="popUpWindowForURL(js_urlCommunityEditionLicenseAgreement, \'CommunityEditionLicenseAgreement\', 800, 600); return false;">license</a>).</span>';
			html += '</td>';
			html += '</tr>';
			...
			html += '<br>';
			html += '<span class="normalx12StatusBoldClass"><a href="" onclick="popUpWindowForURL(js_urlCommunityEditionProgrammersGuide, \'CommunityEditionProgrammersGuide\', 800, 600); return false;">Programmer\'s Guide</a></span>';
			html += '</td>';
...
// add tabSystem here...
	...
	<cfsavecontent variable="_poweredHTML">
		<cfoutput>
			...
			<br>
			<span class="normalPrompt">The contents of this Site are protected under U.S. and International Copyright Laws. &copy 1990-#Year(Now())# Hierarchical Applications Limited, All Rights Reserved.</span>
		</cfoutput>
	</cfsavecontent>
				...
				<table id="table_outerContentWrapper" width="100%" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td valign="top" align="left">
							...
							<small><a href="" target="_blank" onclick="popUpWindowForURL('#newsletter_url#', 'Newsletter', 800, 600); return false;">July 2006 Newsletter</a></small>
							<br>
						</td>
					</tr>
					<tr>
