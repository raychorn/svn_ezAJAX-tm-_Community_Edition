	...
	<cfscript>
		function _userDefinedAJAXFunctions(qryStruct) {
			...
			try {
				...
				//				QuerySetCell(qObj, 'CONTENT', '<small>2.1 SOME CONTENT for (#qryStruct.namedArgs.aName#) in (#Request.qryStruct['ezWebRoot']#) (#Request.qryStruct['ezWebRootPrefix']#)</small>', qObj.recordCount);
