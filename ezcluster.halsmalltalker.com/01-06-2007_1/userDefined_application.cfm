...
<cfscript>
	...
	if (CGI.SERVER_NAME contains 'ezcluster.') {
	...
	} else if (CGI.SERVER_NAME contains 'flash.') {
		Request.cfincludeCFM = 'app/flash/index.html'; // This can be a comma-delimited list of ColdFusion source files that are included in the order specified during the index.cfm processing cycle.
	}
