<cfoutput>
	...
	<cfsavecontent variable="jsCodeStore0">
		...
		var bool_isServerProduction = ((('#boolIsServerProduction#' == 'true') || ('#boolIsServerProduction#' == 'YES')) ? true : false);
		
	//	alert('bool_isServerProduction=[' + bool_isServerProduction + ']' + ', #boolIsServerProduction#');
			...
			<table width="900" align="center" border="0" cellpadding="1" cellspacing="1">
				<tr>
					<td valign="top" align="left">
						<div<cfif (NOT boolIsServerProduction)> style="position: absolute; top: 90;"</cfif>>
												...
												<tr>
													<td align="center">
														<span class="textBoldClass">
															<a href="http://71.133.203.27:8085" target="_blank">Babylon5</a>&nbsp;|&nbsp;
															<a href="http://71.133.203.27:8085/server.htm" target="_blank">Babylon5 Admin</a>
															<br>
													...
													<td align="center">
														<span class="textBoldClass">
															<a href="http://71.133.203.26:8085" target="_blank">Stayme</a>&nbsp;|&nbsp;
															<a href="http://71.133.203.26:8085/server.htm" target="_blank">Stayme Admin</a>
															<br>
													...
													<td align="center">
														<span class="textBoldClass">
															<a href="http://71.133.203.28:8085" target="_blank">CFServer2</a>&nbsp;|&nbsp;
															<a href="http://71.133.203.28:8085/server.htm" target="_blank">CFServer2 Admin</a>
															<br>
	...
	<cfelse>
		<div id="table_outerContentWrapper" style="position: absolute; width: 900px; top: 0px; left: 0px; background-color: black;">
			<table width="900" align="center" border="0" cellpadding="1" cellspacing="1">
				<tr>
					<td>
						<h3 style="color: yellow;">See also: <a href="http://www.ez-ajax.com">www.ez-ajax.com</a> or <a href="http://flash.ez-ajax.com">flash.ez-ajax.com</a></h3>
					</td>
				</tr>
			</table>
		</div>
