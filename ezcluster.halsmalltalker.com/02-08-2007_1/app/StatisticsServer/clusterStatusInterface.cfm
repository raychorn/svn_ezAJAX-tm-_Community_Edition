...
<cfoutput>
	...
	<cftry>
		...
		<cfelse>
			<cfhttp url="http://www.#serverNum#.contentopia.net/test.htm" method="GET" port="#CGI.SERVER_PORT#" result="rHTTP1" resolveurl="yes"></cfhttp>
			<cfhttp url="http://www.#serverNum#.contentopia.net/test.cfm" method="GET" port="#CGI.SERVER_PORT#" result="cfHTTP1" resolveurl="yes"></cfhttp>
		</cfif>
