<cfcomponent displayname="Blog" output="no">
	...
	<cffunction name="init" access="public" hint="Initialize the blog engine" output="no">
		...
		<cfscript>
			writeOutput("cfgFile=[#cfgFile#]<br/>");
		...
		<cftry>
			...
			<cfscript>
				writeOutput(Request.primitiveCode.cfdump(this.instance,'201.1',false));
			</cfscript>

			<cfcatch type="Any">
				<cfscript>
					writeOutput(Request.primitiveCode.cfdump(cfcatch,'ERROR 201',false));
				</cfscript>
			</cfcatch>
		</cftry>
	...
	<cffunction name="saveEntry" access="public" returnType="void" output="false"
		...
		<cfquery datasource="#instance.dsn#">
			...
			set		title = <cfqueryparam value="#arguments.title#" cfsqltype="CF_SQL_CHAR" maxlength="100">,
				    ...
				    <cfelse>
     					,morebody = <cfqueryparam null="yes" value="#arguments.morebody#" cfsqltype="CF_SQL_LONGVARCHAR">
					</cfif>
					<cfif len(arguments.alias)>
