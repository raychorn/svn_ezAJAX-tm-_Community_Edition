		...
		<cfoutput>
			...
			<div id="div_ContactUsContentContainer" style="margin: 5px 5px 5px 5px;">
				<table width="100%">
					<tr>
						<td bgcolor="silver">
							<img src="http://#CGI.SERVER_NAME#/dojo-0.3.1-ajax/demos/widget/images/icon_email.png" width="32" border="0" align="baseline">&nbsp;<span class="normalBigPrompt" style="color: blue; margin-bottom: 15px;">Contact Us</span>
						</td>
					</tr>
					<tr>
						<td align="center">
			...
			<cfoutput>
				<div id="div_#cName#1ContentContainer" style="margin: 5px 5px 5px 5px;">
					<table width="100%">
						...
						<tr>
							<td>
								<p align="justify" class="normalPrompt"><b>ezAJAX Version 0.94 is now ready for downloads and is completely compatible with <a href="" onclick="try { sampleAppsText(); } catch(e) { ezAlertError(ezErrorExplainer(e)); }; return false;">the Dojo Toolkit</a></b>.<br><br>
								...
								It was quite easy to integrate ezAJAX with <a href="" onclick="try { sampleAppsText(); } catch(e) { ezAlertError(ezErrorExplainer(e)); }; return false;">the Dojo Toolkit</a> - ezAJAX offers a superior AJAX Engine that compliments the slick GUI effects found in <a href="" onclick="try { sampleAppsText(); } catch(e) { ezAlertError(ezErrorExplainer(e)); }; return false;">the Dojo Toolkit</a>.<br><br>
								The problem with <a href="" onclick="try { sampleAppsText(); } catch(e) { ezAlertError(ezErrorExplainer(e)); }; return false;">the Dojo Toolkit</a> is that it suffers from a weak Client-Server integration and it offers no server API support as well as providing a slower GUI interface than ezAJAX.<br><br>
								We have provided some <a href="" onclick="try { sampleAppsText(); } catch(e) { ezAlertError(ezErrorExplainer(e)); }; return false;">sample Dojo Toolkit Apps</a> to demonstrate our level of compatability with the Dojo Toolkit for those who may be using the Dojo Toolkit.<br><br>
				...
				<cfoutput>
					<div id="div_DownloadsContentContainer" style="margin: 5px 5px 5px 5px;">
						<table width="100%" cellpadding="-1" cellspacing="-1">
							<tr>
								<td bgcolor="silver">
									<cfset _someText = "Demos, Tutorials & Product Info">
									<cfif (id is 'Downloads')>
										<cfset _someText = "ezAJAX Downloads">
									</cfif>
									<img src="http://#CGI.SERVER_NAME#/app/images/icons/32x32/run-software.gif" width="32" border="0" align="baseline">&nbsp;<span class="normalBigPrompt" style="color: blue; margin-bottom: 15px;">#_someText#</span>
								</td>
							</tr>
							<cfif (id is 'Downloads')>
								<tr>
