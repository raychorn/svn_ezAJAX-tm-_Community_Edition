								...
								<table width="100%" cellpadding="-1" cellspacing="-1">
									...
									<tr>
										<td align="right">
											...
											<a href="" target="_blank" title="This site has been determined to be 100% Safe from Hacker intrusions and is protected by our state-of-the-art anti-hacker protection system known as 'Hacker Dog'#cf_trademarkSymbol#." onmouseover="handleOnMouseOverHackerSafe();" onmouseout="handleOnMouseOutHackerSafe();" onclick="return false; popUpWindowForURL(window.location.protocol + '//' + window.location.hostname + '/app/hackerSafe.html', 'hackerSafe', 700, 550, false, true); return false;" style="color: black;"><span id="span_hackerSafe"><img src="app/images/Hacker Dog (small).gif" width="113" height="56" border="0"><br>(#DateFormat(Now(), "medium")# #TimeFormat(Now(), "short")#)</span></a>
											</span>
										</td>
									</tr>
								</table>
...
//		ezAlert(oAJAXEngine);
	...
	//			oDiv.src = js_ezAJAX_LogoImage;
		...
		function handleOnMouseOverHackerSafe() {
			var oSpan = _$('span_hackerSafe');
			if (!!oSpan) {
				oSpan.className = 'hackerSafeHoverClass';
			}
		}

		function handleOnMouseOutHackerSafe() {
			var oSpan = _$('span_hackerSafe');
			if (!!oSpan) {
				oSpan.className = '';
			}
				...
				<table width="100%" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td valign="top">
							<table width="100%" cellpadding="-1" cellspacing="-1">
								<tr>
									<td id="td_articleContent" width="80%" valign="top" align="left">
										<table width="100%" cellpadding="-1" cellspacing="-1">
											<tr>
									...
									<td width="20%" valign="bottom" align="right">
										<img src="app/images/siteLogoLowerRightTransparent.gif" alt="" width="225" height="185" border="0">
									</td>
								</tr>
							</table>
						</td>
							...
							<table width="100%" cellpadding="-1" cellspacing="-1">
								<tr>
									<td width="50%" align="left" valign="top">
										...
										<span class="normalPrompt">
										<a id="anchor_optIn" name="anchor_optIn" href="" onmouseover="ezThoughtBubbleObj.showThoughtBubbleForAnchor(this.id); return false;" onmouseout="ezThoughtBubbleObj.dismissThoughtBubbleForAnchor(this.id); return false;" onclick="var oObj = _$('#divName_optIn#'); if (!!oObj) { oObj.style.display = const_inline_style; }; return false;">Opt-In</a>&nbsp;|&nbsp;
										<a id="anchor_July2006Newsletter" name="anchor_July2006Newsletter" href="" target="_blank" onmouseover="ezThoughtBubbleObj.showThoughtBubbleForAnchor(this.id); return false;" onmouseout="ezThoughtBubbleObj.dismissThoughtBubbleForAnchor(this.id); return false;" onclick="popUpWindowForURL('#newsletter_url#', 'Newsletter', 660, 550, true); return false;">July 2006 Newsletter</a>&nbsp;|&nbsp;
										<a id="anchor_optOut" name="anchor_optOut" href="" onmouseover="ezThoughtBubbleObj.showThoughtBubbleForAnchor(this.id); return false;" onmouseout="ezThoughtBubbleObj.dismissThoughtBubbleForAnchor(this.id); return false;" onclick="var oObj = _$('#divName_optOut#'); if (!!oObj) { oObj.style.display = const_inline_style; }; return false;">Opt-Out</a>
										</span>
									</td>
									<td width="50%">
										<table width="100%" cellpadding="-1" cellspacing="-1">
											<tr>
												<td width="80%" align="center">
													<span class="normalPrompt">
													<a id="anchor_RegNow_BuyNow" name="anchor_RegNow_BuyNow" href="http://www.regnow.com/softsell/nph-softsell.cgi?item=14605-1" target="_blank" onmouseover="ezThoughtBubbleObj.showThoughtBubbleForAnchor(this.id); return false;" onmouseout="ezThoughtBubbleObj.dismissThoughtBubbleForAnchor(this.id); return false;">Buy Now</a>
													</span>
												</td>
