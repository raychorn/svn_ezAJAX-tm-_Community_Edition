...
<cfsavecontent variable="content_101_2"> <!--- 101.2 --->
	<cfoutput>
		...
		<tr>
		<td align="left" valign="top">
		<span class="normalSmallPrompt">Affiliates, We pay 10% - 60% Commissions Per Sale</span>&nbsp;&nbsp;
...
// add tabSystem here...
	...
	<table id="table_outerContentWrapper" width="700" align="center" cellpadding="-1" cellspacing="-1" style="background-color: white;">
		<tr>
			<td width="*">
				<table width="100%" cellpadding="-1" cellspacing="-1">
					<tr>
									...
									<td width="100%" align="left" valign="top">
										...
										<cfelse>
											<table width="100%" border="0" cellpadding="-1" cellspacing="-1">
												<tr>
													<td width="700">
														<a href="http://www.ez-ajax.com"><img id="image_logoBanner" src="#Request.commonCode.ezClusterizeURL('http://#CGI.SERVER_NAME#/app/images/ezAJAX-banner_800x90.jpg')#" width="800" border="0"></a>
													</td>
													<td width="*">
					...
					<tr>
						<td valign="top" align="left">
							...
							<span class="normalPrompt"><a href="" target="_blank" onclick="popUpWindowForURL('#newsletter_url#', 'Newsletter', 800, 550); return false;">July 2006 Newsletter</a></span>
							<br>
						</td>
					</tr>
					<tr>
