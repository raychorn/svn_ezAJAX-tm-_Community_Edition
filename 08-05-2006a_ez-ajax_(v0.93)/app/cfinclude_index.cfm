		...
		<table width="100%" cellpadding="-1" cellspacing="-1">
			<tr>
				<td>
					...
					<span class="normalPrompt"><b>ezAJAX#cf_trademarkSymbol# has an expanded Programmer's Guide with a Tutorial Primer that explains how to use ezAJAX#cf_trademarkSymbol# after it has been installed.</b></span>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
					<p align="justify" class="normalPrompt"><b>ezAJAX#cf_trademarkSymbol# Version 0.92 is now compatible with Dojo 0.3.1</b>&nbsp;
					You can <a href="" onclick="#cf_urlDojoMailSample#; return false;">view our Dojo Sample - the Mail Sample Application</a> as taken from Dojo 0.3.1.<cfif (Request.commonCode.ezIsBrowserIE())><br><cfelse>&nbsp;&nbsp;</cfif>
								...
								<table width="100%" cellpadding="-1" cellspacing="-1">
									<tr>
										<td width="50%" align="left" valign="top">
											...
											<span class="normalPrompt">
											<a id="anchor_optIn" name="anchor_optIn" href="" title="Click this link to Opt-In to receive our Monthly Newsletters" onmouseover="ezThoughtBubbleObj.showThoughtBubbleForAnchor(this.id, ((ezAJAXEngine.browser_is_ff) ? 240 : 120), ((ezAJAXEngine.browser_is_ff) ? -120 : -60), ((ezAJAXEngine.browser_is_ff) ? -15 : -30)); return false;" onmouseout="ezThoughtBubbleObj.dismissThoughtBubbleForAnchor(this.id); return false;" onclick="var oObj = _$('#divName_optIn#'); if (!!oObj) { oObj.style.display = const_inline_style; }; return false;">Opt-In</a>&nbsp;|&nbsp;
											<a id="anchor_July2006Newsletter" name="anchor_July2006Newsletter" href="" title="The July 2006 Monthly Newsletter" onmouseover="ezThoughtBubbleObj.showThoughtBubbleForAnchor(this.id, ((ezAJAXEngine.browser_is_ff) ? 180 : 160), ((ezAJAXEngine.browser_is_ff) ? -50 : -60), ((ezAJAXEngine.browser_is_ff) ? -0 : -0)); return false;" onmouseout="ezThoughtBubbleObj.dismissThoughtBubbleForAnchor(this.id); return false;" onclick="popUpWindowForURL('#newsletter_url#', 'Newsletter', 660, 550, true); return false;">July 2006 Newsletter</a>&nbsp;|&nbsp;
