function doAJAX_func(_oAJAXEngine, cmd, callBackFuncName, vararg_params) {
	...
	var sValue = '&cfm=' + cmd + '&sessid=' + ((!!cf_Session_ID) ? cf_Session_ID : '') + '&referer=' + ((!!cf_cgiReferer) ? cf_cgiReferer : '') + '&AUTH_USER=' + ((!!js_AUTH_USER) ? js_AUTH_USER : '') + '&callBack=' + callBackFuncName;
