				...
				<table width="100%" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td>
							...
							You can <a href="" onclick="#cf_urlDojoMailSample#; return false;">view our Dojo Sample - the Mail Sample Application</a> as taken from <a href="" onclick="try { sampleAppsText(); } catch(e) { } finally { }; return false;">the Dojo Toolkit</a>.<cfif (ezIsBrowserIE())>&nbsp;<cfelse>&nbsp;&nbsp;</cfif>
									...
									<tr>
										<td valign="top">
											<table width="100%" cellpadding="-1" cellspacing="-1">
												...
												<tr>
													<td align="center">
														<span class="normalPrompt"><a href="" onclick="#cf_urlDojoMailSample#; return false;">Dojo Toolkit Mail Sample</a></span>
													</td>
												</tr>
												<tr>
													<td align="center">
