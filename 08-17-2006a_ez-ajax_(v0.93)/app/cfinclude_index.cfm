...
//	ezAlert('qObj = [' + qObj + ']');
	...
	//		oTabSystem1.onActivateTabsCallback = function (iTab) { ezAlert('onActivateTabsCallback(' + iTab + ')'); };
	//		oTabSystem1.onClickSubTabCallback = function (iSubtab, iTab) { ezAlert('onClickSubTabCallback(' + iTab + ', ' + iSubtab + ')'); };
	...
	//		ezAlert('oTabSystem1 = [' + oTabSystem1 + ']');
			...
			iSubTabs = oTabSystem1.addSubTab(iTab2, 'Subtab ##1/2');
			iSubTabs = oTabSystem1.addSubTab(iTab2, 'Subtab ##2/2');
			...
			iSubTabs = oTabSystem1.addSubTab(iTab6, 'Subtab ##1/6');
							...
							<td>
								<table width="100%" cellpadding="-1" cellspacing="-1">
									<tr>
										...
										<td width="20%">
											<a id="anchor_siteLogoLowerRightTransparent" name="anchor_siteLogoLowerRightTransparent" href="">&nbsp;</a><a href="http://#CGI.SERVER_NAME#"><img src="app/images/siteLogoLowerRightTransparent3.gif" width="225" border="0"></a>
										</td>
									</tr>
								</table>
							</td>
