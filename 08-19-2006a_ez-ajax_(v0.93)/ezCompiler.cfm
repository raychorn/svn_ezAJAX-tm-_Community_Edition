	...
	<cfsavecontent variable="someContent">
		<cfoutput>
			...
			<cfloop index="_i" from="1" to="#nItems#">
				...
				<cfset Request.debugCompiler = Request.debugCompiler & '<small>[#boolFlag#]</small><textarea readonly rows="10" cols="100" class="textClass">#URLEncodedFormat(_jscode)#</textarea><br>'>
