<cfcomponent displayname="performPopulateContentFor" output="No" extends="userDefinedAJAXFunctions">
	...
	<cfsavecontent variable="content_101_1"> <!--- 101.1 --->
		<cfoutput>
			...
			<p align="justify" class="normalSiteContentTextClass">We give you more than 10,000 lines of code that is already debugged and ready to use.  Our entire Framework is one AJAX Sample App to which you make minor adjustments.  All you need to do after installing ezAJAX#cf_trademarkSymbol# is begin coding your application logic.</p>
	...
	<cfsavecontent variable="content_104_2"> <!--- 104.02 --->
		<cfoutput>
		<div id="div_104_2_ContentContainer" style="margin: 5px 5px 5px 5px;">
	(2). Download the ezAJAX#cf_trademarkSymbol# Installer program to your web server in a folder other than the one that was created or set aside for Step (1).  The ezAJAX#cf_trademarkSymbol# Installer program <b><u>MUST</u></b> be executed using the <u>same</u> Physical Server as the one to which you are installing the ezAJAX#cf_trademarkSymbol# product.  You <b><u>cannot</u></b> do a remote installation across a network, this will not work.  Additionally, the ezAJAX#cf_trademarkSymbol# Installer program works much better when it is running from a folder that has nothing it in but the ezAJAX#cf_trademarkSymbol# Installer program.
		...
		<cfoutput>
			<div id="div_WhatsNewContentContainer" style="margin: 5px 5px 5px 5px;">
				<table width="100%" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td>
							<p align="justify" class="normalPrompt"><b>ezAJAX Version 0.92 is now compatible with <a href="" onclick="try { sampleAppsText(); } catch(e) { } finally { }; return false;">Dojo 0.3.1</a></b>&nbsp;
							...
							It was quite easy to integrate ezAJAX with <a href="" onclick="try { sampleAppsText(); } catch(e) { } finally { }; return false;">Dojo 0.3.1</a> - ezAJAX#cf_trademarkSymbol# offers a superior AJAX Engine that compliments the slick GUI effects found in <a href="" onclick="try { sampleAppsText(); } catch(e) { } finally { }; return false;">Dojo 0.3.1</a>.
							</p>
						</td>
					</tr>
					<tr>
						<td>
							...
							<span class="normalPrompt"><b>ezAJAX Version 0.93 will include the following:</b><br>
							...
							<td>
								<table width="100%" cellpadding="-1" cellspacing="-1">
									<tr>
										...
										<td align="center" valign="top">
											<span class="normalx11StatusBoldClass"><a href="#sCommunityEditionDownloadHref#" target="_blank"><img border="0" src="#imgName#"><br>Community Edition 30-day Trial Edition FREE Download</a></span>
										</td>
										<td align="center" valign="middle">
											<span class="normalx11StatusBoldClass">ColdFusion MX 7</span>
										</td>
											...
											<table width="100%" cellpadding="-1" cellspacing="-1">
												<tr>
																...
																<td>
																	<table width="100%" cellpadding="-1" cellspacing="-1">
																		<tr>
																			...
																			<td>
																				<span class="normalx11TextClass">Free for personal use (<a href="" onclick="popUpWindowForURL(js_urlCommunityEditionLicenseAgreement, 'CommunityEditionLicenseAgreement', 800, 550, true); return false;">license</a>).</span>
																			</td>
																		</tr>
																		<tr>
																			<td>
																			...
																			<td>
																				<span class="normalx11TextClass"><b>$95</b>/Server&nbsp;<b>&sect;</b></span>
																			</td>
																		</tr>
																		<tr>
																			<td>
																		...
																		<tr>
																			<td colspan="3">
																				<span class="normalx9TextClass"><b>&sect;</b>&nbsp;OEM, Partner, Educational and Volume Pricing available upon request.  Community Edition Perpetual License unlocks the limitations built into the Community Edition 30-day Trial.</span>
																			</td>
																		</tr>
																	</table>
																</td>
													...
													<td width="*" align="center" valign="top" style="border-left: thin solid Blue;">
														...
														<br>
														<span class="normalx12StatusBoldClass"><a href="" onclick="' + jsCodeDemoWaferAnalysis + '; return false;">Semiconductor Wafer Analysis Prototype</a></span>
													</td>
												</tr>
											</table>
										</tr>
	...
	<cffunction name="contentSampleApps" output="No" returntype="string" access="private">
		...
		<cfset var _urlWaferAnalysis = "">
		<cfset var cf_CodeDemoWaferAnalysis = "">
