...
function handleOnClickSsmItems(i) {
	var oAnchor = _$('anchor_ssmItems_' + i);
	var oDiv = _$('div_anchor_ssmItems_' + i);
	if ( (!!oAnchor) && (!!oDiv) ) {
		var bool = (oDiv.style.display == const_none_style);
		oDiv.style.display = ((bool) ? const_inline_style : const_none_style);
		oAnchor.style.display = ((bool) ? const_inline_style : const_none_style);
	}
//	alert('i = [' + i + ']' + ', oAnchor = [' + oAnchor + ']' + ', oDiv = [' + oDiv + ']');
}
