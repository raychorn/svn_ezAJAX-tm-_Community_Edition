				...
				<table width="100%" cellpadding="-1" cellspacing="-1">
					<tr>
						<td>
							...
							<span class="normalPrompt"><b>ezAJAX has an expanded <a href="" onclick="try { downloadsDocsText(); } catch(e) { } finally { }; return false;">Programmer's Guide with a Tutorial Primer</a> that explains how to use ezAJAX#cf_trademarkSymbol# after it has been installed.</b></span>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<p align="justify" class="normalPrompt"><b><a href="" onclick="try { oTabSystem1.activateTab(downloadsTab); } catch(e) { } finally { }; return false;">ezAJAX#cf_trademarkSymbol# Version 0.92</a> is now compatible with <a href="" onclick="try { sampleAppsText(); } catch(e) { } finally { }; return false;">Dojo 0.3.1</a></b>&nbsp;
							...
							It was quite easy to integrate ezAJAX#cf_trademarkSymbol# with <a href="" onclick="try { sampleAppsText(); } catch(e) { } finally { }; return false;">Dojo 0.3.1</a> - ezAJAX#cf_trademarkSymbol# offers a superior AJAX Engine that compliments the slick GUI effects found in <a href="" onclick="try { sampleAppsText(); } catch(e) { } finally { }; return false;">Dojo 0.3.1</a>.
							</p>
						</td>
					</tr>
					<tr>
