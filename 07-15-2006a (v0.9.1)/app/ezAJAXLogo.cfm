...
<cfoutput>
	...
	AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab##version=7,0,19,0','width','400','height','200','src','#_urlParentPrefix#/ezAJAX/app/images/ezajax_logo','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','#_urlParentPrefix#/ezAJAX/app/images/ezajax_logo' ); //end AC code
	  ...
	  <param name="movie" value="#_urlParentPrefix#/ezAJAX/app/images/ezajax_logo.swf" />
	  <param name="quality" value="high" />
	  <embed src="#_urlParentPrefix#/ezAJAX/app/images/ezajax_logo.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="400" height="200"></embed>
	</object></noscript>
