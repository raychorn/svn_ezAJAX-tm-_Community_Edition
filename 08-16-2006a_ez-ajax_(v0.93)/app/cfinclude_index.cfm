							...
							<td>
								<table width="100%" cellpadding="-1" cellspacing="-1">
									<tr>
										...
										<td width="20%">
											<a id="anchor_siteLogoLowerRightTransparent" name="anchor_siteLogoLowerRightTransparent" href="">&nbsp;</a><img src="app/images/siteLogoLowerRightTransparent2.gif" width="225" border="0">
										</td>
									</tr>
								</table>
							</td>
