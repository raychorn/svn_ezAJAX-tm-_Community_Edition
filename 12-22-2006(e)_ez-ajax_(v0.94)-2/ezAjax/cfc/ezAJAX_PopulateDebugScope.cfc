<cfcomponent displayname="ezAJAX_PopulateDebugScope" output="No" extends="userDefinedAJAXFunctions">
	<cfscript>
		...
		function listToContentTable(aList, scopeName) {
			...
			_html = _html & '<table width="100%" cellpadding="-1" cellspacing="-1" class="#tableClass#">';
			for (i = 1; i lte n; i = i + 1) {
				...
				if (isSimple) {
					...
					_html = _html & '<td id="btn_fetchDebug_#scopeName#.#ar[i]#" width="20%" valign="top" align="left" style="cursor:hand; cursor:pointer;" title="Click this button to view the #scopeName#.#ar[i]# variable which is (#_value#)." onclick="try { this.disabled = true; this.style.backgroundColor = #sQuote##sQuote#; handle_fetchDebugVariableByName(this.id); } catch (e) { ezAlertError(ezErrorExplainer(e)); }; return false;" onmouseover="this.style.backgroundColor = #sQuote#silver#sQuote#; return false;" onmouseout="this.style.backgroundColor = #sQuote##sQuote#; return false;"><span class="#theClass#">"#scopeName#.#ar[i]#"</span></td>';
					...
					_html = _html & '<td id="btn_fetchDebug_#scopeName#.#ar[i]#" width="20%" valign="top" align="left" style="cursor:hand; cursor:pointer;" title="Click this button to view the #scopeName#.#ar[i]# #varTypeText#." onclick="try { this.disabled = true; this.style.backgroundColor = #sQuote##sQuote#; handle_fetchDebugVariableByName(this.id); } catch (e) { ezAlertError(ezErrorExplainer(e)); }; return false;" onmouseover="this.style.backgroundColor = #sQuote#silver#sQuote#; return false;" onmouseout="this.style.backgroundColor = #sQuote##sQuote#; return false;"><table width="100%" class="#theClass#"><th><NOBR>[#scopeName#.#ar[i]#] (#keyListCount#)</NOBR></th></table></td>';
					_html = _html & '<td valign="top" align="left" title="Debug: div_fetchDebug_#scopeName#.#ar[i]#"><div id="div_fetchDebug_#scopeName#.#ar[i]#" class="buttonClass">[***]</div></td>';
				}
				_html = _html & '</tr>';
			}
