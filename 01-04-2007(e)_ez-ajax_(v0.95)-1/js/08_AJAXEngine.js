...
ezAJAXEngine.isBrowserVersionCertified = function() {
	...
	if ((typeof ezAJAXEngine.browserCertificationCallback) == const_function_symbol) {
		try { if (!bool) ezAJAXEngine.browserCertificationCallback(); } catch (e) { ezAlertError(ezErrorExplainer(e)); };
	}
	return bool;
};
					...
					if (!bool_isAnyErrorRecords) {
						...
						if (callBackJSOrFunc != null) {
							if (bool_isSimplerMethod) {
								...
								if ((typeof callBackJSOrFunc) == const_function_symbol) {
									try { callBackJSOrFunc(qObj); } catch (e) { ezAlertError(ezErrorExplainer(e)); };
								} else {
...
ezAJAXEngine.initDebugMenu = function(ajaxObj) {
	...
	if (!!ajaxObj) {
		...
		if (typeof ajaxObj.showAJAXDebugMenuCallback == const_function_symbol) {
			try { bool_canShowDebugMenu = ajaxObj.showAJAXDebugMenuCallback(); } catch(e) { ezAlertError(ezErrorExplainer(e)); };
		}
		...
		if (typeof ajaxObj.showAJAXScopesMenuCallback == const_function_symbol) {
			try { bool_canShowScopesMenu = ajaxObj.showAJAXScopesMenuCallback(); } catch(e) { ezAlertError(ezErrorExplainer(e)); };
		}
		...
		if (typeof ajaxObj.showAJAXBrowserDebugCallback == const_function_symbol) {
			try { bool_canShowBrowserDebug = ajaxObj.showAJAXBrowserDebugCallback(); } catch(e) { ezAlertError(ezErrorExplainer(e)); };
		}
...
ezAJAXEngine.prototype = {
	...
	showAJAXBegins : function(sMsg, sImage, imageHeight) {
		...
		if (!!cObj) {
			...
			if (typeof this.showAJAXBeginsHrefCallback == const_function_symbol) {
				try { _docHref = this.showAJAXBeginsHrefCallback(docHref); } catch(e) { ezAlertError(ezErrorExplainer(e)); };
			}
			...
			if (!this.isServerBusy_divName_changed) {
				...
				if (frObj != null) {
					...
					if (typeof this.ezAJAX_serverBusyCallback == const_function_symbol) {
						try { this.ezAJAX_serverBusyCallback(cObj, resp); } catch(e) { ezAlertError(ezErrorExplainer(e)); };
					}
					...
					if (typeof this.showAJAXBeginsStylesCallback == const_function_symbol) {
						try { this.showAJAXBeginsStylesCallback(frObj.style, cObj.style); } catch(e) { ezAlertError(ezErrorExplainer(e)); };
					}
				}
			} else {
				if ((typeof this.ezAJAX_serverBusyCallback) == const_function_symbol) {
	...
	create : function() {
		...
		if (typeof this.createAJAXEngineCallback == const_function_symbol) {
			try { this.createAJAXEngineCallback(); } catch(e) { ezAlertError(ezErrorExplainer(e)); };
		}
	...
	hideFrame : function() {
		if (this.isDebugMode()) {
			...
			if (typeof this.hideFrameCallback == const_function_symbol) {
				try { this.hideFrameCallback();	} catch(e) { ezAlertError(ezErrorExplainer(e)); };
			}
		}
	},
	showFrame : function() {
		if (this.isDebugMode()) {
			...
			if (typeof this.showFrameCallback == const_function_symbol) {
				try { this.showFrameCallback();	} catch(e) { ezAlertError(ezErrorExplainer(e)); };
			}
		}
	},
