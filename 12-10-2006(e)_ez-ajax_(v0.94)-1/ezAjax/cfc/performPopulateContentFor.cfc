		...
		<cfoutput>
			<div id="div_Web20API1ContentContainer" style="margin: 5px 5px 5px 5px;">
				<table width="100%">
					...
					<tr>
						<td align="right">
							<span class="titlex12BoldClass">Page Index:</span>&nbsp;<span class="titlex12BoldClass">1</span>&nbsp;<span class="titlex12BoldClass"><a href="" onclick="sampleWeb20APIText(2); return false;">2</a></span>&nbsp;<span class="titlex12BoldClass"><a href="" onclick="sampleWeb20APIText(2); return false;">&gt;&gt;</a></a></span>
						</td>
					</tr>
				</table>
			</div>
		...
		<cfoutput>
			<div id="div_Web20API2ContentContainer" style="margin: 5px 5px 5px 5px;">
				<table width="100%">
					...
					<tr>
						<td align="right">
							<span class="titlex12BoldClass">Page Index:</span>&nbsp;<span class="titlex12BoldClass"><a href="" onclick="sampleWeb20APIText(); return false;">&lt;&lt;</a></span>&nbsp;<span class="titlex12BoldClass"><a href="" onclick="sampleWeb20APIText(); return false;">1</a></span>
						</td>
					</tr>
				</table>
			</div>
