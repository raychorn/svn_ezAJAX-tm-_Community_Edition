...
<cfif (NOT debugJavaScriptPackager)>
		...
		<script language="JavaScript1.2" type="text/javascript" src="#ezAJAX_webRoot#/ezAjax/loader.cfm?out=0&modules=#URLEncodedFormat('ezDebugPanel')#&sig=#Trim(_JavaScriptSignature)#"></script>
