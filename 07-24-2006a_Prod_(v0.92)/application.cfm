...
<cfset makeNewRuntimeLicense = false>
...
<cftry>
	<cfif (makeNewRuntimeLicense) AND (IsDefined("Request.commonCode.writeRuntimeLicenseForEndDate")) AND (IsCustomFunction(Request.commonCode.writeRuntimeLicenseForEndDate))>
		<cfscript>
