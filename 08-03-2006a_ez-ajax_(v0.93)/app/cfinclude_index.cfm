							...
							<table width="100%" cellpadding="-1" cellspacing="-1">
								<tr>
									<td width="50%" align="left" valign="top">
										...
										<a href="" onclick="var oObj = _$('#divName_optIn#'); if (!!oObj) { oObj.style.display = const_inline_style; }; return false;">Opt-In</a>&nbsp;|&nbsp;
										<a href="" target="_blank" onclick="popUpWindowForURL('#newsletter_url#', 'Newsletter', 660, 550, true); return false;">July 2006 Newsletter</a>&nbsp;|&nbsp;
										<a href="" onclick="var oObj = _$('#divName_optOut#'); if (!!oObj) { oObj.style.display = const_inline_style; }; return false;">Opt-Out</a>
										</span>
									</td>
									<td width="50%">
										<table width="100%" cellpadding="-1" cellspacing="-1">
											<tr>
												<td width="50%" align="left">
													<span class="normalPrompt">
													<a href="http://www.regnow.com/softsell/nph-softsell.cgi?item=14605-1" target="_blank">Buy Now</a>
													</span>
												</td>
												<td width="50%" align="center">
													<span class="normalPrompt">
													<a href="" target="_blank" title="This site has been determined to be 100% Hacker Safe and is protected by anti-hacker protection systems." onmouseover="handleOnMouseOverHackerSafe();" onmouseout="handleOnMouseOutHackerSafe();" onclick="popUpWindowForURL(window.location.protocol + '//' + window.location.hostname + '/app/hackerSafe.html', 'hackerSafe', 700, 550, false, true); return false;" style="color: red;"><span id="span_hackerSafe">100% Guaranteed Hacker Safe<br>(#DateFormat(Now(), "medium")# #TimeFormat(Now(), "short")#)</span></a>
													</span>
												</td>
											</tr>
										</table>
